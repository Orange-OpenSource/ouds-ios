...
class OUDSTokensTypographyUITests: XCTestCase {
    ...
    func testTypographyToken_OrangeTheme_TypographyDisplayLarge_Light() {
    ...
    func testTypographyToken_OrangeTheme_TypographyDisplayMedium_Light() {
        let vc = TypographyTokenPage().environment(\.theme, OrangeTheme())
    ...
    func testTypographyToken_OrangeTheme_TypographyHeadingMedium_Light() {
        let vc = TypographyTokenPage().environment(\.theme, OrangeTheme())
    ...
    func testTypographyToken_InverseTheme_TypographyDisplayLarge_Light() {
