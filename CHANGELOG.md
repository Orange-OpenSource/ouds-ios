...
## [Unreleased](https://github.com/Orange-OpenSource/ouds-ios/compare/0.21.0...develop)
...
- Add flip option for icon on the trailing action of the text input (Orange-OpenSource/ouds-ios#1041)
