...
- `Switch` component tokens for `Orange` theme (tokens library v1.8.0) (Orange-OpenSource/ouds-ios#1070)
- `Icon` component tokens for `Orange` theme (tokens library v1.8.0) (Orange-OpenSource/ouds-ios#1070)
