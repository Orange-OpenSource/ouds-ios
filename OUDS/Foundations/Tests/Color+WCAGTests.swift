...
struct ColorWCAGTests {
    ...
    func luminanceForFFFFFFFF() throws {
        let luminance = "#FFFFFFFF".color.luminance
    ...
    func luminanceFor000000FF() throws {
        let luminance = "#000000FF".color.luminance
    ...
    func luminanceForF15E00FF() throws {
        let luminance = "#F15E00FF".color.luminance
    ...
    func luminanceFor26B2FF14() throws {
        let luminance = "#26B2FF14".color.luminance
    ...
    func luminanceFor3DE35A1F() throws {
        let luminance = "#3DE35A1F".color.luminance
    ...
    func whiteColorOnWhiteAlwaysFail() throws {
        ...
        let (ratio, _3to1, _4_5to1) = Color.ratioCheck(foregroundColor, backgroundColor)!
    ...
    func orangeColorsOnOrangeSurfaceMustFailForAll() throws {
        ...
        var (ratio, _3to1, _4_5to1) = Color.ratioCheck(foregroundColor, backgroundColor)!
        #expect(_3to1 == false, "Ratio = \(ratio)")
        #expect(_4_5to1 == false, "Ratio = \(ratio)")

        foregroundColor = "#FF7900FF" // Dark mode
        (ratio, _3to1, _4_5to1) = Color.ratioCheck(foregroundColor, backgroundColor)!
        #expect(_3to1 == false, "Ratio = \(ratio)")
        #expect(_4_5to1 == false, "Ratio = \(ratio)")
    }
    ...
    func blackWhiteOrangeColorsOnStatusAccentMutedSurface() throws {
        ...
        var (ratio, _3to1, _4_5to1) = Color.ratioCheck(foregroundBlack, backgroundColor)!
        #expect(_3to1 == true, "Ratio = \(ratio)")
        #expect(_4_5to1 == true, "Ratio = \(ratio)")
        (ratio, _3to1, _4_5to1) = Color.ratioCheck(foregroundOrangeLight, backgroundColor)!
        #expect(_3to1 == false, "Ratio = \(ratio)")
        #expect(_4_5to1 == false, "Ratio = \(ratio)")

        backgroundColor = "#353228FF" // Orange brand color Warm gray 500
        (ratio, _3to1, _4_5to1) = Color.ratioCheck(foregroundWhite, backgroundColor)!
        #expect(_3to1 == true, "Ratio = \(ratio)")
        #expect(_4_5to1 == true, "Ratio = \(ratio)")
        (ratio, _3to1, _4_5to1) = Color.ratioCheck(foregroundOrangeDark, backgroundColor)!
        #expect(_3to1 == true, "Ratio = \(ratio)")
        #expect(_4_5to1 == false, "Ratio = \(ratio)")
    }
