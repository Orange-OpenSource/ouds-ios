...
extension View {
    ...
    public func displayLarge(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.displayLarge))
    }
    ...
    public func displayMedium(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.displayMedium))
    }
    ...
    public func displaySmall(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.displaySmall))
    }
    ...
    public func headingXLarge(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.headingXLarge))
    }
    ...
    public func headingLarge(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.headingLarge))
    }
    ...
    public func headingMedium(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.headingMedium))
    }
    ...
    public func headingSmall(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.headingSmall))
    }
    ...
    public func bodyDefaultLarge(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.bodyDefaultLarge))
    }
    ...
    public func bodyDefaultMedium(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.bodyDefaultMedium))
    }
    ...
    public func bodyDefaultSmall(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.bodyDefaultSmall))
    }
    ...
    public func bodyModerateLarge(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.bodyModerateLarge))
    }
    ...
    public func bodyModerateMedium(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.bodyModerateMedium))
    }
    ...
    public func bodyModerateSmall(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.bodyModerateSmall))
    }
    ...
    public func bodyStrongLarge(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.bodyStrongLarge))
    }
    ...
    public func bodyStrongMedium(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.bodyStrongMedium))
    }
    ...
    public func bodyStrongSmall(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.bodyStrongSmall))
    }
    ...
    public func labelDefaultXLarge(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.labelDefaultXLarge))
    }
    ...
    public func labelDefaultLarge(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.labelDefaultLarge))
    }
    ...
    public func labelDefaultMedium(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.labelDefaultMedium))
    }
    ...
    public func labelDefaultSmall(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.labelDefaultSmall))
    }
    ...
    public func labelModerateXLarge(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.labelModerateXLarge))
    }
    ...
    public func labelModerateLarge(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.labelModerateLarge))
    }
    ...
    public func labelModerateMedium(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.labelModerateMedium))
    }
    ...
    public func labelModerateSmall(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.labelModerateSmall))
    }
    ...
    public func labelStrongXLarge(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.labelStrongXLarge))
    }
    ...
    public func labelStrongLarge(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.labelStrongLarge))
    }
    ...
    public func labelStrongMedium(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.labelStrongMedium))
    }
    ...
    public func labelStrongSmall(_ theme: OUDSTheme) -> some View {
        modifier(TypographyModifier(family: theme.fontFamily, font: theme.fonts.labelStrongSmall))
    }
