...
@frozen public enum OUDSAlertStatus {
    ...
    ///
    /// - Parameter image: Optional `OUDSImage`  to be displayed in the alert. Pass `nil` if no icon is needed.
    case neutral(image: OUDSImage? = nil)
    ...
    ///
    /// - Parameter image: Optional `OUDSImage`  to be displayed in the alert. Pass `nil` if no icon is needed.
    case accent(image: OUDSImage? = nil)
