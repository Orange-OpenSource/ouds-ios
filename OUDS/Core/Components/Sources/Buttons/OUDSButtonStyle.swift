...
/// - strong: The Strong "call for action" on the page should be singular and prominent, limited to one per view. It should be reserved for the most critical action, such as "Next," "Save," "Submit," etc.
