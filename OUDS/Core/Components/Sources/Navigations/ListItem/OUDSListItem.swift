...
public struct OUDSListItem: View {
    ...
    public var body: some View {
        InteractionButton(isReadOnly: layoutData.style.isReadOnly) {
            ...
            VStack(alignment: .leading, spacing: theme.spaces.fixedNone) {
                ...
                .modifier(ControlItemBordersModifier(interactionState: interactionState, layoutDataStyle: layoutData.style, isSelected: false))

                ControlItemHelperErrorTextContainer(layoutDataStyle: layoutData.style, interactionState: interactionState)
            }
            .frame(minWidth: theme.controlItem.sizeMinWidth, maxWidth: .infinity, minHeight: theme.controlItem.sizeMinHeightDefault, alignment: .center)
    ...
    private var contentColor: Color {
        isEnabled ? theme.colors.contentDefault.color(for: colorScheme) : theme.colors.contentDisabled.color(for: colorScheme)
    }

    private var secondaryContentColor: Color {
        isEnabled ? theme.colors.contentMuted.color(for: colorScheme) : theme.colors.contentDisabled.color(for: colorScheme)
    }
