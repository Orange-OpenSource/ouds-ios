...
public final class OUDSCheckboxViewController: UIViewController {
    ...
    /// - Parameter contrelEvents: The even to process if managed
...
extension OUDSSwiftUIBrige {
    ...
    ///         // sender.isOns: flag for the component value
    ///     }
    ///
    ///     // Then create the OUDSCheckbox inside your UIViewController
    ///     OUDSUIKit.createCheckbox(accessibilityLabel: "Meaningfull accessibility label",
    ///                              isError: true,
