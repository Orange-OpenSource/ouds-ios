...
/// Defined as the group of all **raw tokens** related to **_s**.
/// Values are defined in *DimensionRawTokens+Values.swift* file and generated by the tokenator.
/// ``DimensionRawTokens`` are tokens to use to define *_s* , i.e. kind of values to use for sizes or spaces thanks to ``DimensionRawToken``.
///
