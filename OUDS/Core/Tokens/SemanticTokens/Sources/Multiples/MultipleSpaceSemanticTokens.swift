...
///
/// ```swift
///         // Assuming in Figma with have a space semantic token spaceScaled2xs,
...
///         var spaceScaled2xs: MultipleSpaceSemanticTokens { MultipleSpaceSemanticTokens(compact: spaceScaled2xsMobile, regular: spaceScaled2xsTablet) }
///
///         // If the same value is used whatever the size class is
///         var spaceScaled2xs: MultipleSpaceSemanticTokens { MultipleSpaceSemanticTokens(spaceScaled2xsTabley) }
///
