...
public enum OUDSVersions {
    ...
    /// Version of the Orange brand tokens library (2.4.0)
    public static let themeOrangeBrandVersion = "2.4.0"

    /// Version of the Sosh core tokens library (1.3.0)
    public static let themeSoshCoreVersion = "1.3.0"
    /// Version of the Sosh brand tokens library (2.4.0)
    public static let themeSoshBrandVersion = "2.4.0"

    /// Version of the Orange Compact brand tokens library (2.4.0)
    public static let themeOrangeCompactBrandVersion = "2.4.0"

    /// Version of the Wireframe core tokens library (1.4.0)
    public static let themeWireframeCoreVersion = "1.4.0"
    /// Version of the Wireframe brand tokens library (2.4.0)
    public static let themeWireframeBrandVersion = "2.4.0"
