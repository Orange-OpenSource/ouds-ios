...
extension OrangeBusinessToolsThemeOpacitySemanticTokensProvider: OpacitySemanticTokens {
    ...
    @objc public final var opacityWeakest: OpacitySemanticToken { OpacityRawTokens.opacity40 }
    /// Has for value token OpacityRawTokens.opacity160
    @objc public final var opacityWeaker: OpacitySemanticToken { OpacityRawTokens.opacity160 }
    /// Has for value token OpacityRawTokens.opacity320
    @objc public final var opacityWeak: OpacitySemanticToken { OpacityRawTokens.opacity320 }
    /// Has for value token OpacityRawTokens.opacity560
    @objc public final var opacityMedium: OpacitySemanticToken { OpacityRawTokens.opacity560 }
