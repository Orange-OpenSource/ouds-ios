...
extension OrangeBusinessToolsThemeBadgeComponentTokensProvider: BadgeComponentTokens {
    ...
    @objc public final var badgeSizeSmall: SizeSemanticToken { dimensions.dimension5xs }
    /// Has for value token dimensions.dimension4xs
    @objc public final var badgeSizeMedium: SizeSemanticToken { dimensions.dimension4xs }
    /// Has for value token dimensions.dimension3xs
    @objc public final var badgeSizeLarge: SizeSemanticToken { dimensions.dimension3xs }
}
