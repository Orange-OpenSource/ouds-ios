...
extension OrangeBusinessToolsThemeLinkComponentTokensProvider: LinkComponentTokens {
    ...
    @objc public final var colorContentEnabled: MultipleColorSemanticTokens { colors.actionEnabled }
    ...
    @objc public final var colorChevronEnabled: MultipleColorSemanticTokens { colors.contentBrandPrimary }
    /// Has for value token colors.contentBrandPrimary
    @objc public final var colorChevronHover: MultipleColorSemanticTokens { colors.contentBrandPrimary }
    /// Has for value token colors.contentBrandPrimary
    @objc public final var colorChevronPressed: MultipleColorSemanticTokens { colors.contentBrandPrimary }
    /// Has for value token colors.contentBrandPrimary
    @objc public final var colorChevronFocus: MultipleColorSemanticTokens { colors.contentBrandPrimary }
