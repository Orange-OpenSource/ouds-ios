...
extension OrangeBusinessToolsThemeLinkComponentTokensProvider: LinkComponentTokens {
    ...
    @objc public final var linkColorArrowEnabled: MultipleColorSemanticTokens { colors.colorContentBrandPrimary }
    /// Has for value token colors.colorContentBrandPrimary
    @objc public final var linkColorArrowHover: MultipleColorSemanticTokens { colors.colorContentBrandPrimary }
    /// Has for value token colors.colorContentBrandPrimary
    @objc public final var linkColorArrowPressed: MultipleColorSemanticTokens { colors.colorContentBrandPrimary }
    /// Has for value token colors.colorContentBrandPrimary
    @objc public final var linkColorArrowFocus: MultipleColorSemanticTokens { colors.colorContentBrandPrimary }
    ...
    @objc public final var linkSpaceColumnGapIconDefault: SpaceSemanticToken { spaces.spaceColumnGapXs }
    /// Has for value token spaces.spaceColumnGapXs
    ...
    @objc public final var linkSpaceColumnGapArrowDefault: SpaceSemanticToken { spaces.spaceColumnGap2xs }
    /// Has for value token spaces.spaceColumnGap2xs
    @objc public final var linkSpaceColumnGapArrowSmall: SpaceSemanticToken { spaces.spaceColumnGap2xs }
