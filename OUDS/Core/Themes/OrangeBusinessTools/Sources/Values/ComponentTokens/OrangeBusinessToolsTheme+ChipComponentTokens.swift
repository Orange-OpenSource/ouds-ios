...
extension OrangeBusinessToolsThemeChipComponentTokensProvider: ChipComponentTokens {
    ...
    @objc public final var chipSpacePaddingBlock: SpaceSemanticToken { spaces.spacePaddingBlockXs }
    /// Has for value token spaces.spacePaddingBlockSm
    @objc public final var chipSpacePaddingBlockIconOnly: SpaceSemanticToken { spaces.spacePaddingBlockSm }
    ...
    @objc public final var chipSpacePaddingInlineArrowEnd: SpaceSemanticToken { spaces.spacePaddingInline2xs }
    ...
    @objc public final var chipSpaceColumnGapBadgeArrow: SpaceSemanticToken { spaces.spaceColumnGap2xs }
