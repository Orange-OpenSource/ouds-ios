...
extension OrangeBusinessToolsThemeSwitchComponentTokensProvider: SwitchComponentTokens {
    ...
    /// Has for value token MultipleColorSemanticTokens(light: colors.repositoryPositiveHigh, dark: colors.repositoryPositiveDefault)
    @objc public final var colorTrackSelected: MultipleColorSemanticTokens { MultipleColorSemanticTokens(light: colors.repositoryPositiveHigh, dark: colors.repositoryPositiveDefault) }
