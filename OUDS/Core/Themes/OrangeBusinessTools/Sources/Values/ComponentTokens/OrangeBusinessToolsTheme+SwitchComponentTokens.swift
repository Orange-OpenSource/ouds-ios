...
extension OrangeBusinessToolsThemeSwitchComponentTokensProvider: SwitchComponentTokens {
    ...
    @objc public final var switchColorTrackSelected: MultipleColorSemanticTokens { MultipleColorSemanticTokens(light: colors.colorRepositoryPositiveHigh, dark: colors.colorRepositoryPositiveDefault) }
