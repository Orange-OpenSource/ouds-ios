...
///
/// - Since: 0.17.0
final class OrangeBusinessToolsThemeFontSemanticTokensProvider: AllFontSemanticTokensProvider {
    ...
    init() {
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeBusinessToolsThemeFontSemanticTokensProvider")
        #endif
    }
