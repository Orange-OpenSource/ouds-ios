...
///
/// - Since: 0.17.0
final class OrangeBusinessToolsThemeOpacitySemanticTokensProvider: AllOpacitySemanticTokensProvider {
    ...
    init() {
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeBusinessToolsThemeOpacitySemanticTokensProvider")
        #endif
    }
