...
///
/// - Since: 0.17.0
final class OrangeBusinessToolsThemeListItemComponentTokensProvider: AllListItemComponentTokensProvider {
    ...
    {
        OL.debug("Init of OrangeBusinessToolsThemeListItemComponentTokensProvider")
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeBusinessToolsThemeListItemComponentTokensProvider")
        #endif
    }
    ...
    // the implemention of ListItemComponentTokens is not here but in Core/Themes/OrangeBusinessTools/Values/ComponentTokens/OrangeBusinessToolsTheme+ListItemComponentTokens.swift
    // This declaration of OrangeBusinessToolsThemeListItemComponentTokensProvider is here also to allow to write documentation.
}
