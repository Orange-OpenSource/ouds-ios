...
///
/// - Since: 0.17.0
final class OrangeBusinessToolsThemeSelectComponentTokensProvider: AllSelectComponentTokensProvider {
    ...
    {
        OL.debug("Init of OrangeBusinessToolsThemeSelectComponentTokensProvider")
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeBusinessToolsThemeSelectComponentTokensProvider")
        #endif
    }
    ...
    // the implemention of SelectComponentTokens is not here but in Core/Themes/OrangeBusinessTools/Values/ComponentTokens/OrangeBusinessToolsTheme+SelectComponentTokens.swift
    // This declaration of OrangeBusinessToolsThemeSelectComponentTokensProvider is here also to allow to write documentation.
}
