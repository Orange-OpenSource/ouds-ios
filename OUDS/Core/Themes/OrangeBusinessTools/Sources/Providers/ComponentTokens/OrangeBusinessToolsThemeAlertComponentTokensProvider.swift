...
///
/// - Since: 1.2.0
final class OrangeBusinessToolsThemeAlertComponentTokensProvider: AllAlertComponentTokensProvider {
    ...
    ///    - borders: Provider for border semantic tokens, if nil, default one will be used ( ``OrangeBusinessToolsThemeBorderSemanticTokensProvider``)
    ...
    {
        OL.debug("Init of OrangeBusinessToolsThemeAlertComponentTokensProvider")
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeBusinessToolsThemeAlertComponentTokensProvider")
        #endif
    }
