...
struct OrangeBusinessToolsThemeControlItemComponentTokensProviderTests {

    private var provider: OrangeBusinessToolsThemeControlItemComponentTokensProvider

    init() {
        provider = OrangeBusinessToolsThemeControlItemComponentTokensProvider()
    }
