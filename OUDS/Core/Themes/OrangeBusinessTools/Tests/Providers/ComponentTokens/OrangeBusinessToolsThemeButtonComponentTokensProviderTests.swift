...
struct OrangeBusinessToolsThemeButtonComponentTokensProviderTests {

    private var provider: OrangeBusinessToolsThemeButtonComponentTokensProvider

    init() {
        provider = OrangeBusinessToolsThemeButtonComponentTokensProvider()
    }
