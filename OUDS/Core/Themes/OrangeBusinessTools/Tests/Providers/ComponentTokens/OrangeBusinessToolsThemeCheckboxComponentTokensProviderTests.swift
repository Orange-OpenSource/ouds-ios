...
struct OrangeBusinessToolsThemeCheckboxComponentTokensProviderTests {

    private var provider: OrangeBusinessToolsThemeCheckboxComponentTokensProvider

    init() {
        provider = OrangeBusinessToolsThemeCheckboxComponentTokensProvider()
    }
