...
struct OrangeBusinessToolsThemeRadioButtonComponentTokensProviderTests {

    private var provider: OrangeBusinessToolsThemeRadioButtonComponentTokensProvider

    init() {
        provider = OrangeBusinessToolsThemeRadioButtonComponentTokensProvider()
    }
