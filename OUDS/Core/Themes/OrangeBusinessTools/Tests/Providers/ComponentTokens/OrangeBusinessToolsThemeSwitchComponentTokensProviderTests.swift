...
struct OrangeBusinessToolsThemeSwitchComponentTokensProviderTests {

    private var provider: OrangeBusinessToolsThemeSwitchComponentTokensProvider

    init() {
        provider = OrangeBusinessToolsThemeSwitchComponentTokensProvider()
    }
