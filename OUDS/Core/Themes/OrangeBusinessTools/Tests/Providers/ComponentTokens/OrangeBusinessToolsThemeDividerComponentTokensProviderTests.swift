...
struct OrangeBusinessToolsThemeDividerComponentTokensProviderTests {

    private var provider: OrangeBusinessToolsThemeDividerComponentTokensProvider

    init() {
        provider = OrangeBusinessToolsThemeDividerComponentTokensProvider()
    }
