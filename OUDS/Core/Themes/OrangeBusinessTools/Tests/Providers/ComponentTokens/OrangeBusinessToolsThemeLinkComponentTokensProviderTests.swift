...
struct OrangeBusinessToolsThemeLinkComponentTokensProviderTests {

    private var provider: OrangeBusinessToolsThemeLinkComponentTokensProvider

    init() {
        provider = OrangeBusinessToolsThemeLinkComponentTokensProvider()
    }
