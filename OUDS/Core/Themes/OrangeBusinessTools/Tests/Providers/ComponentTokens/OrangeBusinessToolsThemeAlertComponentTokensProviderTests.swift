...
struct OrangeBusinessToolsThemeAlertComponentTokensProviderTests {

    private var provider: OrangeBusinessToolsThemeAlertComponentTokensProvider

    init() {
        provider = OrangeBusinessToolsThemeAlertComponentTokensProvider()
    }
