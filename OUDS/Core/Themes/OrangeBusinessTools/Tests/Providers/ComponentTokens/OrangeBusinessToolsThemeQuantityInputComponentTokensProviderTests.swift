...
struct OrangeBusinessToolsThemeQuantiyInputComponentTokensProviderTests {

    private var provider: OrangeBusinessToolsThemeQuantityInputComponentTokensProvider

    init() {
        provider = OrangeBusinessToolsThemeQuantityInputComponentTokensProvider()
    }
