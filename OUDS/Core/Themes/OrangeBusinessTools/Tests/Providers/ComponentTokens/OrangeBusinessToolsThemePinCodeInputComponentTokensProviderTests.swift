...
struct OrangeBusinessToolsThemePinCodeInputComponentTokensProviderTests {

    private var provider: OrangeBusinessToolsThemePinCodeInputComponentTokensProvider

    init() {
        provider = OrangeBusinessToolsThemePinCodeInputComponentTokensProvider()
    }
