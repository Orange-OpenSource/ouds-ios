...
struct OrangeBusinessToolsThemeBulletListComponentTokensProviderTests {

    private var provider: OrangeBusinessToolsThemeBulletListComponentTokensProvider

    init() {
        provider = OrangeBusinessToolsThemeBulletListComponentTokensProvider()
    }
