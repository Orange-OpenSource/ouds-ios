...
struct OrangeBusinessToolsThemeChipComponentTokensProviderTests {

    private var provider: OrangeBusinessToolsThemeChipComponentTokensProvider

    init() {
        provider = OrangeBusinessToolsThemeChipComponentTokensProvider()
    }
