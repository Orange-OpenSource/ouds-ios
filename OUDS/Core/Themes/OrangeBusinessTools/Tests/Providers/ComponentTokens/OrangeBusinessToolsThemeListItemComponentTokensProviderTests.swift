...
struct OrangeBusinessToolsThemeListItemComponentTokensProviderTests {

    private var provider: OrangeBusinessToolsThemeListItemComponentTokensProvider

    init() {
        provider = OrangeBusinessToolsThemeListItemComponentTokensProvider()
    }
