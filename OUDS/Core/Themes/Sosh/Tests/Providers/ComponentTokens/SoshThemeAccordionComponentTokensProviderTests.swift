...
struct SoshThemeAccordionComponentTokensProviderTests {

    private var provider: SoshThemeAccordionComponentTokensProvider

    init() {
        provider = SoshThemeAccordionComponentTokensProvider()
    }
