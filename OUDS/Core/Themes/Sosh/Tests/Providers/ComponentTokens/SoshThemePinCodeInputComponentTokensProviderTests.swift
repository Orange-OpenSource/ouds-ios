...
struct SoshThemePinCodeInputComponentTokensProviderTests {

    private var provider: SoshThemePinCodeInputComponentTokensProvider

    init() {
        provider = SoshThemePinCodeInputComponentTokensProvider()
    }
