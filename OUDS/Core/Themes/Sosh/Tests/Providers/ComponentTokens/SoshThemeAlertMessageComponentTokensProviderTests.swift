...
struct SoshThemeAlertMessageComponentTokensProviderTests {

    private var provider: SoshThemeAlertMessageComponentTokensProvider

    init() {
        provider = SoshThemeAlertMessageComponentTokensProvider()
    }
