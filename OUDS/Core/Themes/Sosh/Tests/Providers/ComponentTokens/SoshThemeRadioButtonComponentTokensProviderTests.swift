...
struct SoshThemeRadioButtonComponentTokensProviderTests {

    private var provider: SoshThemeRadioButtonComponentTokensProvider

    init() {
        provider = SoshThemeRadioButtonComponentTokensProvider()
    }
