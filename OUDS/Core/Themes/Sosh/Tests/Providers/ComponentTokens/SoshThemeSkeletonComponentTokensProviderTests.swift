...
struct SoshThemeSkeletonComponentTokensProviderTests {

    private var provider: SoshThemeSkeletonComponentTokensProvider

    init() {
        provider = SoshThemeSkeletonComponentTokensProvider()
    }
