...
struct SoshThemeSelectComponentTokensProviderTests {

    private var provider: SoshThemeSelectComponentTokensProvider

    init() {
        provider = SoshThemeSelectComponentTokensProvider()
    }
