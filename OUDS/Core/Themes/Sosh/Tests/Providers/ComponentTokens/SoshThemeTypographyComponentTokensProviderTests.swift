...
struct SoshThemeTypographyComponentTokensProviderTests {

    private var provider: SoshThemeTypographyComponentTokensProvider

    init() {
        provider = SoshThemeTypographyComponentTokensProvider()
    }
