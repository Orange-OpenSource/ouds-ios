...
struct SoshThemeTextAreaComponentTokensProviderTests {

    private var provider: SoshThemeTextAreaComponentTokensProvider

    init() {
        provider = SoshThemeTextAreaComponentTokensProvider()
    }
