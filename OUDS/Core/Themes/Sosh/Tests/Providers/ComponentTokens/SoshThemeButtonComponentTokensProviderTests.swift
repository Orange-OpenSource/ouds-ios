...
struct SoshThemeButtonComponentTokensProviderTests {

    private var provider: SoshThemeButtonComponentTokensProvider

    init() {
        provider = SoshThemeButtonComponentTokensProvider()
    }
