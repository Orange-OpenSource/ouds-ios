...
struct SoshThemeCategoricalTagComponentTokensProviderTests {

    private var provider: SoshThemeCategoricalTagComponentTokensProvider

    init() {
        provider = SoshThemeCategoricalTagComponentTokensProvider()
    }
