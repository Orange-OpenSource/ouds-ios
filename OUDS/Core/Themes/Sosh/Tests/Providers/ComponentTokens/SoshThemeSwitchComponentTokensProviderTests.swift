...
struct SoshThemeSwitchComponentTokensProviderTests {

    private var provider: SoshThemeSwitchComponentTokensProvider

    init() {
        provider = SoshThemeSwitchComponentTokensProvider()
    }
