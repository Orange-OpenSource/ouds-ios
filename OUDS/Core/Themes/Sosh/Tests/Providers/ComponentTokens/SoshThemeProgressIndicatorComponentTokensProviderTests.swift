...
struct SoshThemeProgressIndicatorComponentTokensProviderTests {

    private var provider: SoshThemeProgressIndicatorComponentTokensProvider

    init() {
        provider = SoshThemeProgressIndicatorComponentTokensProvider()
    }
