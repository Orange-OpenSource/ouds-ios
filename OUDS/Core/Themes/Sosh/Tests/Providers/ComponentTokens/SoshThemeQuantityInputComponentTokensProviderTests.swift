...
struct SoshThemeQuantiyInputComponentTokensProviderTests {

    private var provider: SoshThemeQuantityInputComponentTokensProvider

    init() {
        provider = SoshThemeQuantityInputComponentTokensProvider()
    }
