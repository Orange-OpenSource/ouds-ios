...
struct SoshThemeChipComponentTokensProviderTests {

    private var provider: SoshThemeChipComponentTokensProvider

    init() {
        provider = SoshThemeChipComponentTokensProvider()
    }
