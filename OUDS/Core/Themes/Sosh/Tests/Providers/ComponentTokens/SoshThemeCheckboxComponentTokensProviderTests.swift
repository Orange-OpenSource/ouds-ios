...
struct SoshThemeCheckboxComponentTokensProviderTests {

    private var provider: SoshThemeCheckboxComponentTokensProvider

    init() {
        provider = SoshThemeCheckboxComponentTokensProvider()
    }
