...
struct SoshThemeInputTextComponentTokensProviderTests {

    private var provider: SoshThemeInputTextComponentTokensProvider

    init() {
        provider = SoshThemeInputTextComponentTokensProvider()
    }
