...
struct SoshThemeDividerComponentTokensProviderTests {

    private var provider: SoshThemeDividerComponentTokensProvider

    init() {
        provider = SoshThemeDividerComponentTokensProvider()
    }
