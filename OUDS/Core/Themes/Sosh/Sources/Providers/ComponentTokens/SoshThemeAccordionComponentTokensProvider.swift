...
///
/// - Since: 3.0.0
final class SoshThemeAccordionComponentTokensProvider: AllAccordionComponentTokensProvider {
    ...
    {
        OL.debug("Init of SoshThemeAccordionComponentTokensProvider")
        self.sizes = (sizes ?? SoshThemeSizeSemanticTokensProvider())
        self.spaces = (spaces ?? SoshThemeSpaceSemanticTokensProvider())
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "SoshThemeAccordionComponentTokensProvider")
        #endif
    }
    ...
    // the implementation of AccordionComponentTokens is not here but in Core/Themes/Sosh/Values/ComponentTokens/SoshTheme+AccordionComponentTokens.swift
    // This declaration of SoshThemeAccordionComponentTokensProvider is here also to allow to write documentation.
}
