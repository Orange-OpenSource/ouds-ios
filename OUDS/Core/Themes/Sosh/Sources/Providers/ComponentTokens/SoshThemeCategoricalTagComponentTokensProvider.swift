...
///
/// - Since: 3.0.0
final class SoshThemeCategoricalTagComponentTokensProvider: AllCategoricalTagComponentTokensProvider {
    ...
    init(colors: AllColorSemanticTokensProvider? = nil) {
        OL.debug("Init of SoshThemeCategoricalTagComponentTokensProvider")
        self.colors = (colors ?? SoshThemeColorSemanticTokensProvider())
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "SoshThemeCategoricalTagComponentTokensProvider")
        #endif
    }
    ...
    // the implementation of CategoricalTagComponentTokens is not here but in Core/Themes/Sosh/Values/ComponentTokens/SoshTheme+CategoricalTagComponentTokens.swift
    // This declaration of SoshThemeCategoricalTagComponentTokensProvider is here also to allow to write documentation.
}
