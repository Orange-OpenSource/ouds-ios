...
///
/// - Since: 0.17.0
final class SoshThemeSelectComponentTokensProvider: AllSelectComponentTokensProvider {
    ...
    {
        OL.debug("Init of SoshThemeSelectComponentTokensProvider")
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "SoshThemeSelectComponentTokensProvider")
        #endif
    }
    ...
    // the implemention of SelectComponentTokens is not here but in Core/Themes/Sosh/Values/ComponentTokens/SoshTheme+SelectComponentTokens.swift
    // This declaration of SoshThemeSelectComponentTokensProvider is here also to allow to write documentation.
}
