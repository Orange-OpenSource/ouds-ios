...
///
/// - Since: 3.0.0
final class SoshThemeToastComponentTokensProvider: AllToastComponentTokensProvider {
    ...
    ///    - sizes: Provider for size semantic tokens, if nil, default one will be used ( ``SoshThemeSizeSemanticTokensProvider``)
    init(borders: AllBorderSemanticTokensProvider? = nil,
         dimensions: AllDimensionSemanticTokensProvider? = nil,
         sizes: AllSizeSemanticTokensProvider? = nil)
    {
        OL.debug("Init of SoshThemeToastComponentTokensProvider")
        ...
        self.sizes = (sizes ?? SoshThemeSizeSemanticTokensProvider(dimensions: self.dimensions))
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "SoshThemeToastComponentTokensProvider")
        #endif
    }
    ...
    // the implementation of ToastComponentTokens is not here but in Core/Themes/Sosh/Values/ComponentTokens/SoshTheme+ToastComponentTokens.swift
    // This declaration of SoshThemeToastComponentTokensProvider is here also to allow to write documentation.
}
