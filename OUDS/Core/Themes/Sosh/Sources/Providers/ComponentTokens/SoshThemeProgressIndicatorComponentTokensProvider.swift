...
final class SoshThemeProgressIndicatorComponentTokensProvider: AllProgressIndicatorComponentTokensProvider {
    ...
    // the implementation of AllProgressIndicatorComponentTokensProvider is not here but in Core/Themes/Sosh/Values/ComponentTokens/SoshTheme+ProgressIndicatorComponentTokens.swift
    // This declaration of SoshThemeProgressIndicatorComponentTokensProvider is here also to allow to write documentation.
}
