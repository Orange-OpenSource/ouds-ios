...
///
/// - Since: 0.17.0
final class SoshThemeElevationSemanticTokensProvider: AllElevationSemanticTokensProvider {
    ...
    public init() {
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "SoshThemeElevationSemanticTokensProvider")
        #endif
    }
