...
///
/// - Since: 0.17.0
final class SoshThemeBorderSemanticTokensProvider: AllBorderSemanticTokensProvider {
    ...
    init() {
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "SoshThemeBorderSemanticTokensProvider")
        #endif
    }
