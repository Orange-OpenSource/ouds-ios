...
extension SoshThemeFontSemanticTokensProvider: FontSemanticTokens {
    ...
    @objc public final var fontFamilySystem: FontFamilySemanticToken { SoshBrandFontRawTokens.fontFamilyDefault }
    ...
    @objc public final var fontWeightSystemDefault: FontWeightSemanticToken { FontRawTokens.fontWeight500 }
    /// Has for value token FontRawTokens.fontWeight500
