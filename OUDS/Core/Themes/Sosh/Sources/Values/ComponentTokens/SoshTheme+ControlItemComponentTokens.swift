...
extension SoshThemeControlItemComponentTokensProvider: ControlItemComponentTokens {
    ...
    @objc public final var fontSizeAvatarInitialXlarge: FontSizeSemanticToken { fonts.FontRawTokens.size450 }
    /// Has for value token fonts.FontRawTokens.lineHeight650
    @objc public final var fontLineHeightAvatarInitialXlarge: FontLineHeightSemanticToken { fonts.FontRawTokens.lineHeight650 }
    /// Has for value token fonts.FontRawTokens.letterSpacing450
    @objc public final var fontLetterSpacingAvatarInitialXlarge: FontLetterSpacingSemanticToken { fonts.FontRawTokens.letterSpacing450 }
