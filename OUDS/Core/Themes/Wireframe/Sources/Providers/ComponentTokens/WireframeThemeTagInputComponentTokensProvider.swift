...
///
/// - Since: 0.17.0
final class WireframeThemeTagInputComponentTokensProvider: AllTagInputComponentTokensProvider {
    ...
    {
        OL.debug("Init of WireframeThemeTagInputComponentTokensProvider")
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "WireframeThemeTagInputComponentTokensProvider")
        #endif
    }
    ...
    // the implemention of TagInputComponentTokens is not here but in Core/Themes/Wireframe/Values/ComponentTokens/WireframeTheme+TagInputComponentTokens.swift
    // This declaration of WireframeThemeTagInputComponentTokensProvider is here also to allow to write documentation.
}
