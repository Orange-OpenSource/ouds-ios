...
final class WireframeThemeListItemComponentTokensProvider: AllListItemComponentTokensProvider {
    ...
    // the implemention of ListItemComponentTokens is not here but in Core/Themes/Wireframe/Values/ComponentTokens/WireframeTheme+ListItemComponentTokens.swift
