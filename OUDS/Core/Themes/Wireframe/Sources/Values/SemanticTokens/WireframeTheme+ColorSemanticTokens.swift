...
extension WireframeThemeColorSemanticTokensProvider: ColorSemanticTokens {
    ...
    @objc public final var colorRepositoryPrimaryMedium: ColorSemanticToken { WireframeBrandColorRawTokens.colorRoyalBlue600 }
    ...
    @objc public final var colorRepositorySecondaryMedium: ColorSemanticToken { WireframeBrandColorRawTokens.colorRustyRed600 }
    ...
    /// Has for value token WireframeBrandColorRawTokens.colorRustyRed600
    @objc public final var colorRepositoryAccentMedium: ColorSemanticToken { WireframeBrandColorRawTokens.colorRustyRed600 }
    /// This token has a forbidden color value (#FF000000 in tokenator) and **must not be used if you use this WireframeTheme**
    ...
    /// Has for value token colorRepositorySecondaryMedium
    @objc public final var colorSurfaceBrandSecondaryLight: ColorSemanticToken { colorRepositorySecondaryMedium }
    ...
    /// Has for value token colorRepositorySecondaryMedium
    @objc public final var colorContentBrandSecondaryLight: ColorSemanticToken { colorRepositorySecondaryMedium }
    /// Has for value token colorRepositorySecondaryLow
    ...
    /// Has for value token colorRepositorySecondaryMedium
    @objc public final var colorBorderBrandSecondaryLight: ColorSemanticToken { colorRepositorySecondaryMedium }
    /// Has for value token colorRepositorySecondaryLow
