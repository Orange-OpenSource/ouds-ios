...
extension WireframeThemeLinkComponentTokensProvider: LinkComponentTokens {
    ...
    /// Has for value token colors.actionHover
    @objc public final var colorChevronHover: MultipleColorSemanticTokens { colors.actionHover }
    /// Has for value token colors.actionPressed
    @objc public final var colorChevronPressed: MultipleColorSemanticTokens { colors.actionPressed }
    /// Has for value token colors.actionFocus
    @objc public final var colorChevronFocus: MultipleColorSemanticTokens { colors.actionFocus }
