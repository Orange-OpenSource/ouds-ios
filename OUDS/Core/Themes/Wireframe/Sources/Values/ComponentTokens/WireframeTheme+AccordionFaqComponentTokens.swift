...
extension WireframeThemeAccordionFaqComponentTokensProvider: AccordionFaqComponentTokens {
    ...
    @objc public final var sizeMinHeightDesktop: SizeSemanticToken { DimensionRawTokens._900 }
}
