...
///
///     override init() {
///         super.init(spaces: CustomSpaceTokensProvider(_s: CustomDimensionSemanticTokensProvider()))
///     }
/// }
/// ```
///
...
///
/// ```swift
///     OrangeTheme(spaces: CustomSpaceTokensProvider(_s: CustomDimensionSemanticTokensProvider()))
/// ```
///
/// - Since: 0.8.0
