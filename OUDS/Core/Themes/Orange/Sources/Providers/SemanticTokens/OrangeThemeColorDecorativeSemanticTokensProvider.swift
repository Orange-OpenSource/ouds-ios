...
///
/// - Since: 2.0.0
public final class OrangeThemeColorDecorativeSemanticTokensProvider: AllColorDecorativeSemanticTokensProvider {
    ...
    public init() {
        OL.debug("Init of OrangeThemeColorDecorativeSemanticTokensProvider")
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeThemeColorDecorativeSemanticTokensProvider")
        #endif
    }
    ...
    // but in Core/Themes/Orange/Values/SemanticTokens/OrangeTheme+ColorDecorativeSemanticTokens
    // This declaration of OrangeThemeColorDecorativeSemanticTokensProvider is here to allow to write documentation.
}
