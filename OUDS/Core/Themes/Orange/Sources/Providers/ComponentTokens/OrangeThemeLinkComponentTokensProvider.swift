...
///
///         override var linkColorArrowHover: MultipleColorSemanticTokens { colors.colorRepositoryOpacityBlackHigher }
///
...
///
/// - Since: 0.9.0
open class OrangeThemeLinkComponentTokensProvider {
