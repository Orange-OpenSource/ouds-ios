...
/// *Breadcrumb* components tokens are defined with raw and semantic tokens of sizes (from `AllSizeSemanticTokensProvider`),
...
///
///         override var breadcrumbSizeMinHeightMedium: SizeSemanticToken { DimensionRawTokens.dimension550 }
///
///         override var breadcrumbColorContentEnabled: MultipleColorSemanticTokens { colors.colorDecorativeSkinTint200 }
///
///         override var breadcrumbSpaceColumnGapLevelsMedium: SpaceSemanticToken { spaces.spaceColumnGapShorter }
///
///         // ...
///     }
///
