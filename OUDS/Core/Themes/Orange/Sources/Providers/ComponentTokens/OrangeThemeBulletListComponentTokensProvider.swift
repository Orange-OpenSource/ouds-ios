...
open class OrangeThemeBulletListComponentTokensProvider: AllBulletListComponentTokensProvider {
    ...
    // the implementation of BulletListComponentTokens is not here but in Core/Themes/Orange/Values/ComponentTokens/OrangeTheme+BulletListComponentTokens.swift
