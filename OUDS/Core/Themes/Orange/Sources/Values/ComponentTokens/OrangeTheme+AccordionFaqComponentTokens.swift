...
extension OrangeThemeAccordionFaqComponentTokensProvider: AccordionFaqComponentTokens {
    ...
    /// Has for value token spaces.columnGapLarge (= 16)
    @objc open var spaceColumnGapDesktop: SpaceSemanticToken { spaces.columnGapLarge }
    ...
    @objc open var spacePaddingBlockDesktop: SpaceSemanticToken { spaces.paddingBlockLarge }
    ...
    /// Has for value token spaces.paddingBlock4xlarge (= 32)
    @objc open var spacePaddingBlockBottomExpandContainerDesktop: SpaceSemanticToken { spaces.paddingBlock4xlarge }
    /// Has for value token spaces.paddingBlockLarge (= 16)
    ...
    /// Has for value token spaces.paddingBlockXlarge (= 20)
    @objc open var spacePaddingBlockBottomSlotListItemContainerDesktop: SpaceSemanticToken { spaces.paddingBlockXlarge }
    ...
    /// Has for value token sizes.iconWithLabelXlargeSizeMedium (= 36)
    @objc open var sizeIconDesktop: SizeSemanticToken { sizes.iconWithLabelXlargeSizeMedium }
    ...
    /// Has for value token sizes.iconWithLabelLargeSizeMedium (= 28)
    @objc open var sizeExpandingIndicatorDesktop: SizeSemanticToken { sizes.iconWithLabelLargeSizeMedium }
    ...
    @objc open var sizeMinHeightDesktop: SizeSemanticToken { DimensionRawTokens._900 }
}
