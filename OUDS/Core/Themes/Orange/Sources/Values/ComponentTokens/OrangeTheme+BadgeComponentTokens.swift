...
extension OrangeThemeBadgeComponentTokensProvider: BadgeComponentTokens {
    ...
    @objc open var spacePaddingInlineLarge: SpaceSemanticToken { {ouds1f4a0_paddingInline2xsmall }
    /// Has for value token {ouds1f4a0_paddingInline3xsmall (= 4)
    @objc open var spacePaddingInlineMedium: SpaceSemanticToken { {ouds1f4a0_paddingInline3xsmall }
}
