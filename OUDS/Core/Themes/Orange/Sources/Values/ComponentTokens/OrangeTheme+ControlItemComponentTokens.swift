...
=======
    ...
    @objc open var colorBgCurrentEnabled: MultipleColorSemanticToken {
        MultipleColorSemanticToken(light: colors.actionSupportEnabledLight, dark: colors.actionSupportHoverDark)
    }

    /// Has for value token colors.actionSupportHover
    @objc open var colorBgCurrentHover: MultipleColorSemanticToken {
        colors.actionSupportHover
    }

    /// Has for value token colors.actionSupportPressed
    @objc open var colorBgCurrentPressed: MultipleColorSemanticToken {
        colors.actionSupportPressed
    }

    /// Has for value token colors.actionSupportDisabled
    @objc open var colorBgCurrentDisabled: MultipleColorSemanticToken {
        colors.actionSupportDisabled
    }

    /// Has for value token colors.actionSupportFocus
    @objc open var colorBgCurrentFocus: MultipleColorSemanticToken {
        colors.actionSupportFocus
    }

    /// Has for value token colors.contentDefault
    @objc open var colorContentCurrentEnabled: MultipleColorSemanticToken {
        colors.contentDefault
    }

    /// Has for value token colors.contentDefault
    @objc open var colorContentCurrentHover: MultipleColorSemanticToken {
        colors.contentDefault
    }

    /// Has for value token colors.contentDefault
    @objc open var colorContentCurrentPressed: MultipleColorSemanticToken {
        colors.contentDefault
    }

    /// Has for value token colors.contentDefault
    @objc open var colorContentCurrentDisabled: MultipleColorSemanticToken {
        colors.contentDefault
    }

    /// Has for value token colors.contentDefault
    @objc open var colorContentCurrentFocus: MultipleColorSemanticToken {
        colors.contentDefault
    }

    /// Has for value token colors.bgPrimary
    @objc open var colorBadgeSafetyArea: MultipleColorSemanticToken {
        colors.bgPrimary
    }

    /// Has for value token FontRawTokens.size450
    @objc open var fontSizeAvatarInitialXlarge: FontSizeSemanticToken {
        FontRawTokens.size450
    }

    /// Has for value token FontRawTokens.lineHeight650
    @objc open var fontLineHeightAvatarInitialXlarge: FontLineHeightSemanticToken {
        FontRawTokens.lineHeight650
    }

    /// Has for value token FontRawTokens.letterSpacing450
    @objc open var fontLetterSpacingAvatarInitialXlarge: FontLetterSpacingSemanticToken {
        FontRawTokens.letterSpacing450
    }

    /// Has for value token opacities.opaque
    @objc open var opacityCurrentIndicator: OpacitySemanticToken {
        opacities.opaque
    }

    /// Has for value token opacities.opaque
    @objc open var opacityCurrentDivider: OpacitySemanticToken {
        opacities.opaque
    }

    /// Has for value token borders.widthDefault
    @objc open var borderWidthDefault: BorderWidthSemanticToken {
        borders.widthDefault
    }

    /// Has for value token borders.widthMedium
    @objc open var borderWidthCurrentPage: BorderWidthSemanticToken {
        borders.widthMedium
    }
    ...
    @objc open var borderRadiusRounded: BorderRadiusSemanticToken {
        borders.radiusMedium
    }

    /// Has for value token borders.radiusDefault
    @objc open var borderRadiusMedia: BorderRadiusSemanticToken {
        borders.radiusDefault
    }

    /// Has for value token borders.radiusSmall
    @objc open var borderRadiusMediaRoundedCorner: BorderRadiusSemanticToken {
        borders.radiusSmall
    }

    /// Has for value token borders.radiusNone
    @objc open var borderRadiusCurrentIndicator: BorderRadiusSemanticToken {
        borders.radiusNone
    }

    /// Has for value token spaces.paddingInlineLarge
    @objc open var spacePaddingInline: SpaceSemanticToken {
        spaces.paddingInlineLarge
    }

    /// Has for value token spaces.columnGapMedium
    @objc open var spaceColumnGap: SpaceSemanticToken {
        spaces.columnGapMedium
    }

    /// Has for value token spaces.rowGapNone
    @objc open var spaceRowGap: SpaceSemanticToken {
        spaces.rowGapNone
    }

    /// Has for value token spaces.paddingBlockXsmall
    @objc open var spacePaddingBlockTopHelperText: SpaceSemanticToken {
        spaces.paddingBlockXsmall
    }

    /// Has for value token spaces.paddingBlock3xsmall
    @objc open var spacePaddingBlockBottomSlot: SpaceSemanticToken {
        spaces.paddingBlock3xsmall
    }

    /// Has for value token spaces.paddingBlockXsmall
    @objc open var spacePaddingBlockDensityCompact: SpaceSemanticToken {
        spaces.paddingBlockXsmall
    }
    ...
    /// Has for value token spaces.paddingBlockXsmall
    @objc open var spacePaddingBlockDensityCompactTopAlignmentTopCounterweight: SpaceSemanticToken {
        spaces.paddingBlockXsmall
    }

    /// Has for value token spaces.paddingBlock2xlarge
    @objc open var spacePaddingBlockDensityCompactBottomExpandContainer: SpaceSemanticToken {
        spaces.paddingBlock2xlarge
    }

    /// Has for value token spaces.paddingBlockMedium
    @objc open var spacePaddingBlockDensityDefault: SpaceSemanticToken {
        spaces.paddingBlockMedium
    }

    /// Has for value token spaces.paddingBlock4xsmall
    @objc open var spacePaddingBlockDensityDefaultTopAlignmentTopTextContainer: SpaceSemanticToken {
        spaces.paddingBlock4xsmall
    }

    /// Has for value token spaces.paddingBlockSmall
    @objc open var spacePaddingBlockDensityDefaultTopAlignmentTopCounterweight: SpaceSemanticToken {
        spaces.paddingBlockSmall
    }

    /// Has for value token spaces.paddingBlock3xlarge
    @objc open var spacePaddingBlockDensityDefaultBottomExpandContainer: SpaceSemanticToken {
        spaces.paddingBlock3xlarge
    }

    /// Has for value token sizes.iconWithLabelLargeSizeXsmall
    @objc open var sizeControlIndicator: SizeSemanticToken {
        sizes.iconWithLabelLargeSizeXsmall
    }

    /// Has for value token sizes.minInteractiveArea
    @objc open var sizeMinHeightCompact: SizeSemanticToken {
        sizes.minInteractiveArea
    }

    /// Has for value token DimensionRawTokens._750
    @objc open var sizeMinHeightDefault: SizeSemanticToken {
        DimensionRawTokens._750
    }

    /// Has for value token DimensionRawTokens._2000
    @objc open var sizeMinWidth: SizeSemanticToken {
        DimensionRawTokens._2000
    }

    /// Has for value token DimensionRawTokens._4000
    @objc open var sizeMaxWidth: SizeSemanticToken {
        DimensionRawTokens._4000
    }

    /// Has for value token sizes.iconWithLabelLargeSizeSmall
    @objc open var sizeAssetSmall: SizeSemanticToken {
        sizes.iconWithLabelLargeSizeSmall
    }

    /// Has for value token sizes.iconWithLabelLargeSizeMedium
    @objc open var sizeAssetMedium: SizeSemanticToken {
        sizes.iconWithLabelLargeSizeMedium
    }

    /// Has for value token dimensions._medium
    @objc open var sizeAssetLarge: SizeSemanticToken {
        dimensions._medium
    }

    /// Has for value token dimensions._3xlarge
    @objc open var sizeAssetXlarge: SizeSemanticToken {
        dimensions._3xlarge
    }

    /// Has for value token sizes.iconWithLabelLargeSizeXsmall
    @objc open var sizeFlagHeight: SizeSemanticToken {
        sizes.iconWithLabelLargeSizeXsmall
    }

    /// Has for value token DimensionRawTokens._50
    @objc open var sizeCurrentIndicatorWidth: SizeSemanticToken {
...
=======
    /// Has for value token colors.actionSupportHover
    @objc open var colorBgHover: MultipleColorSemanticToken {
        colors.actionSupportHover
    }

    /// Has for value token colors.actionSupportPressed
    @objc open var colorBgPressed: MultipleColorSemanticToken {
        colors.actionSupportPressed
    }

    /// Has for value token colors.actionSupportLoading
    @objc open var colorBgLoading: MultipleColorSemanticToken {
        colors.actionSupportLoading
    }

    /// Has for value token colors.actionSupportFocus
    @objc open var colorBgFocus: MultipleColorSemanticToken {
        colors.actionSupportFocus
    }

    /// Has for value token colors.contentDefault
    @objc open var colorContentLoader: MultipleColorSemanticToken {
        colors.contentDefault
    }
    ...
    /// Has for value token borders.radiusDefault
    @objc open var borderRadiusItemOnly: BorderRadiusSemanticToken {
        borders.radiusDefault
    }

    /// Has for value token spaces.paddingBlockMedium
    @objc open var spacePaddingBlockDefault: SpaceSemanticToken {
        spaces.paddingBlockMedium
    }

    /// Has for value token spaces.paddingInline4xsmall
    @objc open var spacePaddingInlineErrorIcon: SpaceSemanticToken {
        spaces.paddingInline4xsmall
    }

    /// Has for value token DimensionRawTokens._1200
    @objc open var sizeMaxHeightAssetsContainer: SizeSemanticToken {
        DimensionRawTokens._1200
    }

    /// Has for value token sizes.iconWithLabelLargeSizeSmall
    @objc open var sizeErrorIcon: SizeSemanticToken {
        sizes.iconWithLabelLargeSizeSmall
    }
