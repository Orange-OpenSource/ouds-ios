...
extension OrangeThemeControlItemComponentTokensProvider: ControlItemComponentTokens {
    ...
    @objc open var fontSizeAvatarInitialXlarge: FontSizeSemanticToken { fonts.FontRawTokens.size450 }
    /// Has for value token fonts.FontRawTokens.lineHeight650
    @objc open var fontLineHeightAvatarInitialXlarge: FontLineHeightSemanticToken { fonts.FontRawTokens.lineHeight650 }
    /// Has for value token fonts.FontRawTokens.letterSpacing450
    @objc open var fontLetterSpacingAvatarInitialXlarge: FontLetterSpacingSemanticToken { fonts.FontRawTokens.letterSpacing450 }
