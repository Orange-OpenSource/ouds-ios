...
extension OrangeThemeBulletListComponentTokensProvider: BulletListComponentTokens {
    ...
    @objc open var bulletListSpacePaddingBlockBodyLarge: SpaceSemanticToken { spaces.spacePaddingBlockXs }
    /// Has for value token spaces.spacePaddingBlockXs
    @objc open var bulletListSpacePaddingBlockBodyMedium: SpaceSemanticToken { spaces.spacePaddingBlockXs }
