...
extension OrangeThemeTextInputComponentTokensProvider: TextInputComponentTokens {
    ...
    @objc open var textInputSpacePaddingInlineTrailingAction: SpaceSemanticToken { spaces.spacePaddingInline2xs }
    ...
    /// Has for value token spaces.spaceColumnGapXs
    @objc open var textInputSpaceColumnGapTrailingErrorAction: SpaceSemanticToken { spaces.spaceColumnGapXs }
