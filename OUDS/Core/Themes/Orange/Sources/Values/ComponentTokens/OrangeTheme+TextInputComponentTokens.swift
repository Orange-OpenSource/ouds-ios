...
extension OrangeThemeTextInputComponentTokensProvider: TextInputComponentTokens {
    ...
    @objc open var ouds1f4a0TextInputColorBorderEnabled: MultipleColorSemanticTokens { colors.colorBorderDefault }
    /// Has for value token colors.colorActionHover
    @objc open var ouds1f4a0TextInputColorBorderHover: MultipleColorSemanticTokens { colors.colorActionHover }
    /// Has for value token colors.colorBorderEmphasized
    @objc open var ouds1f4a0TextInputColorBorderFocus: MultipleColorSemanticTokens { colors.colorBorderEmphasized }
    /// Has for value token colors.colorBorderEmphasized
    @objc open var ouds1f4a0TextInputColorBorderLoading: MultipleColorSemanticTokens { colors.colorBorderEmphasized }
