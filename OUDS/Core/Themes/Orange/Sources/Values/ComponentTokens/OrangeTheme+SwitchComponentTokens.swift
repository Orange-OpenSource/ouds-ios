...
extension OrangeThemeSwitchComponentTokensProvider: SwitchComponentTokens {
    ...
    @objc open var switchSpacePaddingInlineSelected: SpaceSemanticToken { spaces.spaceFixedShortest }
    @objc open var switchSpacePaddingInlineUnselected: SpaceSemanticToken { spaces.spaceFixedShorter }
}
