...
extension OrangeThemeSwitchComponentTokensProvider: SwitchComponentTokens {
    ...
    @objc open var spacePaddingInlineSelected: SpaceSemanticToken { {ouds1f4a0_paddingInline3xsmall }
    /// Has for value token {ouds1f4a0_paddingInlineXsmall (= 8)
    @objc open var spacePaddingInlineUnselected: SpaceSemanticToken { {ouds1f4a0_paddingInlineXsmall }
}
