...
extension OrangeThemeSwitchComponentTokensProvider: SwitchComponentTokens {
    @objc open var switchColorCursor: MultipleColorSemanticTokens { colors.colorFunctionalWhite }
    @objc open var switchColorTrackSelected: MultipleColorSemanticTokens { colors.colorFunctionalMalachite500 }
    @objc open var switchColorTrackSelectedInteraction: MultipleColorSemanticTokens { colors.colorFunctionalMalachite600 }
    @objc open var switchColorTrackUnselected: MultipleColorSemanticTokens { colors.colorOpacityBlack440 }
    @objc open var switchColorTrackUnselectedInteraction: MultipleColorSemanticTokens { colors.colorOpacityBlack520 }
