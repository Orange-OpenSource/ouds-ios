...
extension OrangeThemeSwitchComponentTokensProvider: SwitchComponentTokens {
    ...
    @objc open var colorTrackSelected: MultipleColorSemanticTokens { MultipleColorSemanticTokens(light: colors.repositoryPositiveHigh, dark: colors.repositoryPositiveDefault) }
