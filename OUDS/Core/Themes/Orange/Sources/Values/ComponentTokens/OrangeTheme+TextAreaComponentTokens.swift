...
extension OrangeThemeTextAreaComponentTokensProvider: TextAreaComponentTokens {
    ...
    /// Has for value token spaces.paddingBlockSmall
    @objc open var spacePaddingBlockTrailingContainer: SpaceSemanticToken { spaces.paddingBlockSmall }
    /// Has for value token spaces.paddingBlockXsmall
    @objc open var spacePaddingBlockEmptyTrailingContainer: SpaceSemanticToken { spaces.paddingBlockXsmall }
