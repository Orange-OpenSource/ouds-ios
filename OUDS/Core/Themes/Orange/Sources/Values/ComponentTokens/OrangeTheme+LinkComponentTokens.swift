...
extension OrangeThemeLinkComponentTokensProvider: LinkComponentTokens {
    @objc open var linkColorContentDisabledMono: MultipleColorSemanticTokens { colors.colorOpacityBlack280 }
    @objc open var linkColorContentEnabledMono: MultipleColorSemanticTokens { colors.colorFunctionalBlack }
    @objc open var linkColorContentFocusMono: MultipleColorSemanticTokens { colors.colorFunctionalBlack }
    @objc open var linkColorContentHoverMono: MultipleColorSemanticTokens { colors.colorFunctionalBlack }
    @objc open var linkColorContentPressedMono: MultipleColorSemanticTokens { colors.colorOpacityBlack680 }
