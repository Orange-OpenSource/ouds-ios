...
extension OrangeThemeTagComponentTokensProvider: TagComponentTokens {
    ...
    @objc open var spaceInsetBulletDefault: SpaceSemanticToken { DimensionRawTokens.dimensionOutOfSystem75 }
    /// Has for value token spaces.inset3xsmall
    ...
    @objc open var sizeMinHeightDefault: SizeSemanticToken { dimensions.dimensionXsmall }
    /// Has for value token dimensions.dimensionLarge
    @objc open var sizeMinWidthSmall: SizeSemanticToken { dimensions.dimensionLarge }
    /// Has for value token dimensions.dimensionXlarge
    @objc open var sizeMinWidthDefault: SizeSemanticToken { dimensions.dimensionXlarge }
