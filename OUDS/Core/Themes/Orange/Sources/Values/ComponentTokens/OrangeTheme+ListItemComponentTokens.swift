...
extension OrangeThemeListItemComponentTokensProvider: ListItemComponentTokens {
    ...
    @objc open var spacePaddingBlockBottomSlotListItemContainer: SpaceSemanticToken { {ouds1f4a0_paddingBlockLarge }
    ...
    @objc open var spacePaddingBlockSlotTextContainer: SpaceSemanticToken { {ouds1f4a0_paddingBlock3xsmall }
    /// Has for value token {ouds1f4a0_paddingBlockXsmall (= 8)
    @objc open var spacePaddingBlockSmall: SpaceSemanticToken { {ouds1f4a0_paddingBlockXsmall }
    /// Has for value token {ouds1f4a0_paddingBlockSmall (= 10)
    @objc open var spacePaddingBlockTopAlignmentTopCounterweightDefault: SpaceSemanticToken { {ouds1f4a0_paddingBlockSmall }
    /// Has for value token {ouds1f4a0_paddingBlockXsmall (= 8)
    @objc open var spacePaddingBlockTopAlignmentTopCounterweightSmall: SpaceSemanticToken { {ouds1f4a0_paddingBlockXsmall }
    /// Has for value token {ouds1f4a0_paddingBlock4xsmall (= 2)
    @objc open var spacePaddingBlockTopAlignmentTopTextContainerDefault: SpaceSemanticToken { {ouds1f4a0_paddingBlock4xsmall }
    /// Has for value token {ouds1f4a0_paddingBlockNone (= 0)
    @objc open var spacePaddingBlockTopAlignmentTopTextContainerSmall: SpaceSemanticToken { {ouds1f4a0_paddingBlockNone }
    /// Has for value token {ouds1f4a0_paddingBlockXsmall (= 8)
    @objc open var spacePaddingBlockTopHelperText: SpaceSemanticToken { {ouds1f4a0_paddingBlockXsmall }
    ...
    @objc open var spacePaddingInlineErrorIcon: SpaceSemanticToken { {ouds1f4a0_paddingInline4xsmall }
    /// Has for value token {ouds1f4a0_rowGapNone (= 0)
    @objc open var spaceRowGap: SpaceSemanticToken { {ouds1f4a0_rowGapNone }
}
