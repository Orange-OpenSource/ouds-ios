...
extension OrangeThemeButtonComponentTokensProvider: ButtonComponentTokens {
    @objc open var buttonColorBgDefaultFocusMono: MultipleColorSemanticTokens { colors.colorOpacityBlack680 }
    @objc open var buttonColorBgDefaultHoverMono: MultipleColorSemanticTokens { colors.colorOpacityBlack680 }
    @objc open var buttonColorBgDefaultLoadingMono: MultipleColorSemanticTokens { colors.colorOpacityWhite800 }
    @objc open var buttonColorBgDefaultPressedMono: MultipleColorSemanticTokens { colors.colorOpacityWhite800 }
    @objc open var buttonColorBgMinimalFocusMono: MultipleColorSemanticTokens { colors.colorOpacityBlack680 }
    @objc open var buttonColorBgMinimalHoverMono: MultipleColorSemanticTokens { colors.colorOpacityBlack680 }
    @objc open var buttonColorBgMinimalLoadingMono: MultipleColorSemanticTokens { colors.colorOpacityWhite800 }
    @objc open var buttonColorBgMinimalPressedMono: MultipleColorSemanticTokens { colors.colorOpacityWhite800 }
    @objc open var buttonColorBgStrongDisabledMono: MultipleColorSemanticTokens { colors.colorOpacityBlack280 }
    @objc open var buttonColorBgStrongEnabledMono: MultipleColorSemanticTokens { colors.colorFunctionalBlack }
    @objc open var buttonColorBgStrongFocusMono: MultipleColorSemanticTokens { colors.colorOpacityBlack680 }
    @objc open var buttonColorBgStrongHoverMono: MultipleColorSemanticTokens { colors.colorOpacityBlack680 }
    @objc open var buttonColorBgStrongLoadingMono: MultipleColorSemanticTokens { colors.colorOpacityWhite800 }
    @objc open var buttonColorBgStrongPressedMono: MultipleColorSemanticTokens { colors.colorOpacityWhite800 }
    @objc open var buttonColorBorderDefaultDisabledMono: MultipleColorSemanticTokens { colors.colorOpacityBlack280 }
    @objc open var buttonColorBorderDefaultEnabledMono: MultipleColorSemanticTokens { colors.colorFunctionalBlack }
    @objc open var buttonColorContentDefaultDisabledMono: MultipleColorSemanticTokens { colors.colorOpacityBlack280 }
    @objc open var buttonColorContentDefaultEnabledMono: MultipleColorSemanticTokens { colors.colorFunctionalBlack }
    @objc open var buttonColorContentDefaultFocusMono: MultipleColorSemanticTokens { colors.colorFunctionalWhite }
    @objc open var buttonColorContentDefaultHoverMono: MultipleColorSemanticTokens { colors.colorFunctionalWhite }
    @objc open var buttonColorContentDefaultLoadingMono: MultipleColorSemanticTokens { colors.colorFunctionalBlack }
    @objc open var buttonColorContentDefaultPressedMono: MultipleColorSemanticTokens { colors.colorFunctionalBlack }
    @objc open var buttonColorContentMinimalDisabledMono: MultipleColorSemanticTokens { colors.colorOpacityBlack280 }
    @objc open var buttonColorContentMinimalEnabledMono: MultipleColorSemanticTokens { colors.colorFunctionalBlack }
    @objc open var buttonColorContentMinimalFocusMono: MultipleColorSemanticTokens { colors.colorFunctionalWhite }
    @objc open var buttonColorContentMinimalHoverMono: MultipleColorSemanticTokens { colors.colorFunctionalWhite }
    @objc open var buttonColorContentMinimalLoadingMono: MultipleColorSemanticTokens { colors.colorFunctionalBlack }
    @objc open var buttonColorContentMinimalPressedMono: MultipleColorSemanticTokens { colors.colorFunctionalBlack }
    @objc open var buttonColorContentStrongDisabledMono: MultipleColorSemanticTokens { colors.colorOpacityWhite640 }
    @objc open var buttonColorContentStrongEnabledMono: MultipleColorSemanticTokens { colors.colorFunctionalWhite }
    @objc open var buttonColorContentStrongFocusMono: MultipleColorSemanticTokens { colors.colorFunctionalWhite }
    @objc open var buttonColorContentStrongHoverMono: MultipleColorSemanticTokens { colors.colorFunctionalWhite }
    @objc open var buttonColorContentStrongLoadingMono: MultipleColorSemanticTokens { colors.colorFunctionalBlack }
    @objc open var buttonColorContentStrongPressedMono: MultipleColorSemanticTokens { colors.colorFunctionalBlack }
