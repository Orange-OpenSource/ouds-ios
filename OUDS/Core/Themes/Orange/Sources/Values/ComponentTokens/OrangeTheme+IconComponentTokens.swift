...
extension OrangeThemeIconComponentTokensProvider: IconComponentTokens {
    ...
    @objc open var colorContentStatusWarningExternalShape: MultipleColorSemanticTokens { MultipleColorSemanticTokens(light: colors.repositoryWarningDefault, dark: colors.repositoryWarningLow) }
