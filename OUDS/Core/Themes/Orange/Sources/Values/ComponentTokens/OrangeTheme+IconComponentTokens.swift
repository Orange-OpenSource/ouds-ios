...
extension OrangeThemeIconComponentTokensProvider: IconComponentTokens {
    ...
    @objc open var iconColorContentStatusWarningExternalShape: MultipleColorSemanticTokens { MultipleColorSemanticTokens(light: colors.colorRepositoryWarningDefault, dark: colors.colorRepositoryWarningLow) }
