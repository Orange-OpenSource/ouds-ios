...
extension OrangeThemeFontSemanticTokensProvider: FontSemanticTokens {
    ...
    @objc open var fontFamilySystem: FontFamilySemanticToken { OrangeBrandFontRawTokens.fontFamilyBrandDefault }
    ...
    @objc open var fontWeightSystemModerate: FontWeightSemanticToken { FontRawTokens.fontWeight500 }
