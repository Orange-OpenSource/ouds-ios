...
extension OrangeThemeColorModeSemanticTokensProvider: ColorModeSemanticTokens {
    ...
    /// Has for value token ColorModeRawTokens.dark
    @objc open var modeOnBgInverseLowLight: ColorModeSemanticToken { ColorModeRawTokens.dark }
    /// Has for value token ColorModeRawTokens.dark
    @objc open var modeOnBgInverseLowDark: ColorModeSemanticToken { ColorModeRawTokens.dark }
    /// Has for value token ColorModeRawTokens.dark
    @objc open var modeOnBgInverseHighLight: ColorModeSemanticToken { ColorModeRawTokens.dark }
    /// Has for value token ColorModeRawTokens.light
    @objc open var modeOnBgInverseHighDark: ColorModeSemanticToken { ColorModeRawTokens.light }
    /// Has for value token ColorModeRawTokens.light
    @objc open var modeOnSurfacePrimaryLight: ColorModeSemanticToken { ColorModeRawTokens.light }
    /// Has for value token ColorModeRawTokens.dark
    @objc open var modeOnSurfacePrimaryDark: ColorModeSemanticToken { ColorModeRawTokens.dark }
    /// Has for value token ColorModeRawTokens.light
    @objc open var modeOnSurfaceSecondaryLight: ColorModeSemanticToken { ColorModeRawTokens.light }
    /// Has for value token ColorModeRawTokens.dark
    @objc open var modeOnSurfaceSecondaryDark: ColorModeSemanticToken { ColorModeRawTokens.dark }
    /// Has for value token ColorModeRawTokens.light
    @objc open var modeOnSurfaceTertiaryLight: ColorModeSemanticToken { ColorModeRawTokens.light }
    /// Has for value token ColorModeRawTokens.dark
    @objc open var modeOnSurfaceTertiaryDark: ColorModeSemanticToken { ColorModeRawTokens.dark }
    /// Has for value token ColorModeRawTokens.dark
    @objc open var modeOnSurfaceInverseLowLight: ColorModeSemanticToken { ColorModeRawTokens.dark }
    /// Has for value token ColorModeRawTokens.dark
    @objc open var modeOnSurfaceInverseLowDark: ColorModeSemanticToken { ColorModeRawTokens.dark }
    /// Has for value token ColorModeRawTokens.dark
    @objc open var modeOnSurfaceInverseHighLight: ColorModeSemanticToken { ColorModeRawTokens.dark }
    /// Has for value token ColorModeRawTokens.light
    @objc open var modeOnSurfaceInverseHighDark: ColorModeSemanticToken { ColorModeRawTokens.light }
    ...
    /// Has for value token ColorModeRawTokens.light
    @objc open var modeOnOverlayDropdownLight: ColorModeSemanticToken { ColorModeRawTokens.light }
    /// Has for value token ColorModeRawTokens.dark
    @objc open var modeOnOverlayDropdownDark: ColorModeSemanticToken { ColorModeRawTokens.dark }
    /// Has for value token ColorModeRawTokens.dark
    @objc open var modeOnOverlayTooltipLight: ColorModeSemanticToken { ColorModeRawTokens.dark }
    /// Has for value token ColorModeRawTokens.dark
    @objc open var modeOnOverlayTooltipDark: ColorModeSemanticToken { ColorModeRawTokens.dark }
    /// Has for value token ColorModeRawTokens.light
