...
struct OrangeThemeQuantiyInputComponentTokensProviderTests {

    private var provider: OrangeThemeQuantityInputComponentTokensProvider

    init() {
        provider = OrangeThemeQuantityInputComponentTokensProvider()
    }
