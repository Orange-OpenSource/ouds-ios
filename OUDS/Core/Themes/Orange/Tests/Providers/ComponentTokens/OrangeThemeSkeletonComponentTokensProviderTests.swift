...
struct OrangeThemeSkeletonComponentTokensProviderTests {

    private var provider: OrangeThemeSkeletonComponentTokensProvider

    init() {
        provider = OrangeThemeSkeletonComponentTokensProvider()
    }
