...
struct OrangeThemeListItemComponentTokensProviderTests {

    private var provider: OrangeThemeListItemComponentTokensProvider

    init() {
        provider = OrangeThemeListItemComponentTokensProvider()
    }
