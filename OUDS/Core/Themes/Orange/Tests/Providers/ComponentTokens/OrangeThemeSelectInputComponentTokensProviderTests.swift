...
struct OrangeThemeSelectInputComponentTokensProviderTests {

    private var provider: OrangeThemeSelectInputComponentTokensProvider

    init() {
        provider = OrangeThemeSelectInputComponentTokensProvider()
    }
