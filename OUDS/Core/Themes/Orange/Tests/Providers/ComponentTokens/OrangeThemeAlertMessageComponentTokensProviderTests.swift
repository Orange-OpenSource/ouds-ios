...
struct OrangeThemeAlertMessageComponentTokensProviderTests {

    private var provider: OrangeThemeAlertMessageComponentTokensProvider

    init() {
        provider = OrangeThemeAlertMessageComponentTokensProvider()
    }
