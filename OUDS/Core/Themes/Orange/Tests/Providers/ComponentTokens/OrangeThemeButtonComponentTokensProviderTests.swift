...
struct OrangeThemeButtonComponentTokensProviderTests {

    private var provider: OrangeThemeButtonComponentTokensProvider

    init() {
        provider = OrangeThemeButtonComponentTokensProvider()
    }
