...
struct OrangeThemeInputTextComponentTokensProviderTests {

    private var provider: OrangeThemeInputTextComponentTokensProvider

    init() {
        provider = OrangeThemeInputTextComponentTokensProvider()
    }
