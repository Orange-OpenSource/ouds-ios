...
struct OrangeThemeAccordionComponentTokensProviderTests {

    private var provider: OrangeThemeAccordionComponentTokensProvider

    init() {
        provider = OrangeThemeAccordionComponentTokensProvider()
    }
