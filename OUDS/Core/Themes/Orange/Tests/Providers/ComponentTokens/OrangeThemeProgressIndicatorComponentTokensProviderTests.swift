...
struct OrangeThemeProgressIndicatorComponentTokensProviderTests {

    private var provider: OrangeThemeProgressIndicatorComponentTokensProvider

    init() {
        provider = OrangeThemeProgressIndicatorComponentTokensProvider()
    }
