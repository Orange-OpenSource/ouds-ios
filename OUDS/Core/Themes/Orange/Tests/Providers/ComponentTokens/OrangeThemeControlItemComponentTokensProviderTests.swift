...
struct OrangeThemeControlItemComponentTokensProviderTests {

    private var provider: OrangeThemeControlItemComponentTokensProvider

    init() {
        provider = OrangeThemeControlItemComponentTokensProvider()
    }
