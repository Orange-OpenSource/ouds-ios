...
struct OrangeThemeTagComponentTokensProviderTests {

    private var provider: OrangeThemeTagComponentTokensProvider

    init() {
        provider = OrangeThemeTagComponentTokensProvider()
    }
