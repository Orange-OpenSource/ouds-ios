...
struct OrangeThemeTypographyComponentTokensProviderTests {

    private var provider: OrangeThemeTypographyComponentTokensProvider

    init() {
        provider = OrangeThemeTypographyComponentTokensProvider()
    }
