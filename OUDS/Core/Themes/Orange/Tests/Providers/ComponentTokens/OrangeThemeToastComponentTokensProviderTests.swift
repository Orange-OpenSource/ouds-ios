...
struct OrangeThemeToastComponentTokensProviderTests {

    private var provider: OrangeThemeToastComponentTokensProvider

    init() {
        provider = OrangeThemeToastComponentTokensProvider()
    }
