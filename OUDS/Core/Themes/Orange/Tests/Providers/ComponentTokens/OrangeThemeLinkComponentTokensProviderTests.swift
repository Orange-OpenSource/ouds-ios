...
struct OrangeThemeLinkComponentTokensProviderTests {

    private var provider: OrangeThemeLinkComponentTokensProvider

    init() {
        provider = OrangeThemeLinkComponentTokensProvider()
    }
