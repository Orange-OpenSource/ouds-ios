...
struct OrangeThemeSwitchComponentTokensProviderTests {

    private var provider: OrangeThemeSwitchComponentTokensProvider

    init() {
        provider = OrangeThemeSwitchComponentTokensProvider()
    }
