...
struct OrangeThemeCategoricalTagComponentTokensProviderTests {

    private var provider: OrangeThemeCategoricalTagComponentTokensProvider

    init() {
        provider = OrangeThemeCategoricalTagComponentTokensProvider()
    }
