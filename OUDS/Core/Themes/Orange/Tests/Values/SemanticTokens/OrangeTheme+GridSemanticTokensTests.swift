...
/// Checks if the semantic tokens of grids, as defined in the Orange theme, have expected values and relationships
/// between them.
struct GridSemanticTokensValuesTests {
    ...
    @Test("Min widths must be smaller than maw widths")
    func widths() throws {
