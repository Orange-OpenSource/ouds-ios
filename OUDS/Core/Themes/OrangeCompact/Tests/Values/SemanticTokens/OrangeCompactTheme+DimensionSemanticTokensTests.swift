...
/// Checks if the closed semantic tokens of dimensions, as defined in the Orange Compact theme, have expected values and relationships
/// between them.
struct DimensionSemanticTokensValuesTests {
    ...
    // NOTE: For Orange Compact some dimensions are not unique
