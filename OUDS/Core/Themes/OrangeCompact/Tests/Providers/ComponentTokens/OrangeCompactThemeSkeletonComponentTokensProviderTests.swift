...
struct OrangeCompactThemeSkeletonComponentTokensProviderTests {

    private var provider: OrangeCompactThemeSkeletonComponentTokensProvider

    init() {
        provider = OrangeCompactThemeSkeletonComponentTokensProvider()
    }
