...
struct OrangeCompactThemeSelectInputComponentTokensProviderTests {

    private var provider: OrangeCompactThemeSelectInputComponentTokensProvider

    init() {
        provider = OrangeCompactThemeSelectInputComponentTokensProvider()
    }
