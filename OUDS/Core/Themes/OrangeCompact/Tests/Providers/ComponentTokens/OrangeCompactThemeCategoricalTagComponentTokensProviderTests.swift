...
struct OrangeCompactThemeCategoricalTagComponentTokensProviderTests {

    private var provider: OrangeCompactThemeCategoricalTagComponentTokensProvider

    init() {
        provider = OrangeCompactThemeCategoricalTagComponentTokensProvider()
    }
