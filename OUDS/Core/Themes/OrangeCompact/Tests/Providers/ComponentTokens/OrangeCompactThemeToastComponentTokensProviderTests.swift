...
struct OrangeCompactThemeToastComponentTokensProviderTests {

    private var provider: OrangeCompactThemeToastComponentTokensProvider

    init() {
        provider = OrangeCompactThemeToastComponentTokensProvider()
    }
