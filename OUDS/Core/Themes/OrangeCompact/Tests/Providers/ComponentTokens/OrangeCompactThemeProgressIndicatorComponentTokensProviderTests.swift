...
struct OrangeCompactThemeProgressIndicatorComponentTokensProviderTests {

    private var provider: OrangeCompactThemeProgressIndicatorComponentTokensProvider

    init() {
        provider = OrangeCompactThemeProgressIndicatorComponentTokensProvider()
    }
