...
struct OrangeCompactThemeCheckboxComponentTokensProviderTests {

    private var provider: OrangeCompactThemeCheckboxComponentTokensProvider

    init() {
        provider = OrangeCompactThemeCheckboxComponentTokensProvider()
    }
