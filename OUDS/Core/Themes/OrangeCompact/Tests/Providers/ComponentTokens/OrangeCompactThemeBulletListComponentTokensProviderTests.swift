...
struct OrangeCompactThemeBulletListComponentTokensProviderTests {

    private var provider: OrangeCompactThemeBulletListComponentTokensProvider

    init() {
        provider = OrangeCompactThemeBulletListComponentTokensProvider()
    }
