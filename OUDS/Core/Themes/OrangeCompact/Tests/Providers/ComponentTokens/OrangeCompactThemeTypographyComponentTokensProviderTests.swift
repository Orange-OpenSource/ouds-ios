...
struct OrangeCompactThemeTypographyComponentTokensProviderTests {

    private var provider: OrangeCompactThemeTypographyComponentTokensProvider

    init() {
        provider = OrangeCompactThemeTypographyComponentTokensProvider()
    }
