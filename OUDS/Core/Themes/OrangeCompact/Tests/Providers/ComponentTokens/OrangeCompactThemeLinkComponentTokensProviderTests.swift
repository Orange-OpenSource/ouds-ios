...
struct OrangeCompactThemeLinkComponentTokensProviderTests {

    private var provider: OrangeCompactThemeLinkComponentTokensProvider

    init() {
        provider = OrangeCompactThemeLinkComponentTokensProvider()
    }
