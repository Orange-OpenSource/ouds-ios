...
struct OrangeCompactThemeDividerComponentTokensProviderTests {

    private var provider: OrangeCompactThemeDividerComponentTokensProvider

    init() {
        provider = OrangeCompactThemeDividerComponentTokensProvider()
    }
