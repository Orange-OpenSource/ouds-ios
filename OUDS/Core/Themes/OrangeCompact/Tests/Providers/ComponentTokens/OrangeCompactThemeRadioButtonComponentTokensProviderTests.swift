...
struct OrangeCompactThemeRadioButtonComponentTokensProviderTests {

    private var provider: OrangeCompactThemeRadioButtonComponentTokensProvider

    init() {
        provider = OrangeCompactThemeRadioButtonComponentTokensProvider()
    }
