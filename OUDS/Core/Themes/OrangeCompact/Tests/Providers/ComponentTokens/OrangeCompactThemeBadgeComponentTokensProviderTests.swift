...
struct OrangeCompactThemeBadgeComponentTokensProviderTests {

    private var provider: OrangeCompactThemeBadgeComponentTokensProvider

    init() {
        provider = OrangeCompactThemeBadgeComponentTokensProvider()
    }
