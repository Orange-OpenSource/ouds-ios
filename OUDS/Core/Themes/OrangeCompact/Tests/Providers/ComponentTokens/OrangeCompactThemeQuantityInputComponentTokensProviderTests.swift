...
struct OrangeCompactThemeQuantiyInputComponentTokensProviderTests {

    private var provider: OrangeCompactThemeQuantityInputComponentTokensProvider

    init() {
        provider = OrangeCompactThemeQuantityInputComponentTokensProvider()
    }
