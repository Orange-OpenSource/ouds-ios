...
struct OrangeCompactThemeAlertMessageComponentTokensProviderTests {

    private var provider: OrangeCompactThemeAlertMessageComponentTokensProvider

    init() {
        provider = OrangeCompactThemeAlertMessageComponentTokensProvider()
    }
