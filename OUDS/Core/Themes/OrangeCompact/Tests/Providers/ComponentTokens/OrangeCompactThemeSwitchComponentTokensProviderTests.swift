...
struct OrangeCompactThemeSwitchComponentTokensProviderTests {

    private var provider: OrangeCompactThemeSwitchComponentTokensProvider

    init() {
        provider = OrangeCompactThemeSwitchComponentTokensProvider()
    }
