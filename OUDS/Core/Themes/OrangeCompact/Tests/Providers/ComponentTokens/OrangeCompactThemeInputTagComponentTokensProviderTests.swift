...
struct OrangeCompactThemeInputTagComponentTokensProviderTests {

    private var provider: OrangeCompactThemeInputTagComponentTokensProvider

    init() {
        provider = OrangeCompactThemeInputTagComponentTokensProvider()
    }
