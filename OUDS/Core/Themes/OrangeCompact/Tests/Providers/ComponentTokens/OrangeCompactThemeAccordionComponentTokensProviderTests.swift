...
struct OrangeCompactThemeAccordionComponentTokensProviderTests {

    private var provider: OrangeCompactThemeAccordionComponentTokensProvider

    init() {
        provider = OrangeCompactThemeAccordionComponentTokensProvider()
    }
