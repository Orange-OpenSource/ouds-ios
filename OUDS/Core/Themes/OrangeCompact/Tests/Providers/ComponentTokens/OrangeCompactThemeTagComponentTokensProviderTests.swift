...
struct OrangeCompactThemeTagComponentTokensProviderTests {

    private var provider: OrangeCompactThemeTagComponentTokensProvider

    init() {
        provider = OrangeCompactThemeTagComponentTokensProvider()
    }
