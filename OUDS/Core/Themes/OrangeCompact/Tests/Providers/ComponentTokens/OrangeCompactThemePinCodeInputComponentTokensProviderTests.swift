...
struct OrangeCompactThemePinCodeInputComponentTokensProviderTests {

    private var provider: OrangeCompactThemePinCodeInputComponentTokensProvider

    init() {
        provider = OrangeCompactThemePinCodeInputComponentTokensProvider()
    }
