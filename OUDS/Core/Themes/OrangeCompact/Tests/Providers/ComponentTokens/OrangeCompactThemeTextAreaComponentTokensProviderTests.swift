...
struct OrangeCompactThemeTextAreaComponentTokensProviderTests {

    private var provider: OrangeCompactThemeTextAreaComponentTokensProvider

    init() {
        provider = OrangeCompactThemeTextAreaComponentTokensProvider()
    }
