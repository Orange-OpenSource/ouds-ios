...
struct OrangeCompactThemeChipComponentTokensProviderTests {

    private var provider: OrangeCompactThemeChipComponentTokensProvider

    init() {
        provider = OrangeCompactThemeChipComponentTokensProvider()
    }
