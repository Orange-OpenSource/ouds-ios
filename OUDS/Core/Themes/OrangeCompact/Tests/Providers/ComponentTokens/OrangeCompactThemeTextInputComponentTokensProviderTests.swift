...
struct OrangeCompactThemeTextInputComponentTokensProviderTests {

    private var provider: OrangeCompactThemeTextInputComponentTokensProvider

    init() {
        provider = OrangeCompactThemeTextInputComponentTokensProvider()
    }
