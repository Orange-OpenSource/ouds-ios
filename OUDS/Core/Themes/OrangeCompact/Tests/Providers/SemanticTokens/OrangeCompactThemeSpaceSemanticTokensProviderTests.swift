...
struct OrangeCompactThemeSpaceSemanticTokensProviderTests {

    private var provider: OrangeCompactThemeSpaceSemanticTokensProvider

    init() {
        provider = OrangeCompactThemeSpaceSemanticTokensProvider()
    }
