...
struct OrangeCompactThemeColorModeSemanticTokensProviderTests {

    private var provider: OrangeCompactThemeColorModeSemanticTokensProvider

    init() {
        provider = OrangeCompactThemeColorModeSemanticTokensProvider()
    }
