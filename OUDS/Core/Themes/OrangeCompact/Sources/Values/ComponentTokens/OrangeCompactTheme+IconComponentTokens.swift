...
extension OrangeCompactThemeIconComponentTokensProvider: IconComponentTokens {
    ...
    @objc public final var colorContentStatusWarningInverseInternalShape: MultipleColorSemanticToken {
        MultipleColorSemanticToken(light: colors.opacityTransparentDark, dark: colors.repositoryWarningHigh)
    }
