...
///     let tuning = Tuning(hasRoundedButtons: true, hasRoundedTextInputs: true, hasRoundedAlertMessages: false, hasRoundedListItems: true)
///
///     // Apply it to your theme
///     let theme = OrangeCompactTheme(tuning: tuning)
///     // Or in one line
///     let theme = OrangeCompactTheme(tuning: Tuning(hasRoundedButtons: true, hasRoundedTextInputs: true, hasRoundedAlertMessages: false, hasRoundedListItems: true))
///
