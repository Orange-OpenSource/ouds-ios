...
@Metadata {
    @PageImage(purpose: icon, source: "ic_theme_orangecompact")
    @DisplayName("Theme Orange Compact", style: symbol)
...
> Important: The Orange Compact theme is read only: it cannot be suclassed or derivated.
...
@TabNavigator {
    @Tab("Checkbox") {
        ![A checkbox component in light and dark modes with Orange Compact theme](https://ios.unified-design-system.orange.com/images/OUDSComponents/component_checkbox_OrangeCompact.png)        
    }
    @Tab("Checkbox item") {
        ![A checkbox item component in light and dark modes with Orange Compact theme](https://ios.unified-design-system.orange.com/images/OUDSComponents/component_checkboxItem_OrangeCompact.png)
    }
}
...
@TabNavigator {
    @Tab("Radio") {
        ![A radio button component in light and dark modes with Orange Compact theme](https://ios.unified-design-system.orange.com/images/OUDSComponents/component_radio_OrangeCompact.png)        
    }
    @Tab("Radio item") {
        ![A radio item component in light and dark modes with Orange Compact theme](https://ios.unified-design-system.orange.com/images/OUDSComponents/component_radioItem_OrangeCompact.png)
    }
}
...
@TabNavigator {
    @Tab("Switch") {
        ![A switch component in light and dark modes with Orange Compact theme](https://ios.unified-design-system.orange.com/images/OUDSComponents/component_switch_OrangeCompact.png)        
    }
    @Tab("Switch item") {
        ![A switch item component in light and dark modes with Orange Compact theme](https://ios.unified-design-system.orange.com/images/OUDSComponents/component_switchItem_OrangeCompact.png)
    }
}
...
@TabNavigator {
    @Tab("Badge standard") {
        ![A badge standard component in light and dark modes with Orange Compact theme](https://ios.unified-design-system.orange.com/images/OUDSComponents/component_badge_OrangeCompact.png)
    }
    @Tab("Badge count") {
        ![A badge count component in light and dark modes with Orange Compact theme](https://ios.unified-design-system.orange.com/images/OUDSComponents/component_badgeCount_OrangeCompact.png)
    }
    @Tab("Badge icon") {
        ![A badge icon component in light and dark modes with Orange Compact theme](https://ios.unified-design-system.orange.com/images/OUDSComponents/component_badgeIcon_OrangeCompact.png)
    }
}
...
@TabNavigator {
    @Tab("Horizontal divider") {
        ![An horizontal divider component in light and dark modes with Orange Compact theme](https://ios.unified-design-system.orange.com/images/OUDSComponents/component_horizontalDivider_OrangeCompact.png)
    }
    @Tab("Vertical divider") {
        ![A vertical divider component in light and dark modes with Orange Compact theme](https://ios.unified-design-system.orange.com/images/OUDSComponents/component_verticalDivider_OrangeCompact.png)
    }
}
...
@TabNavigator {
    @Tab("Static") {
        ![A static list item component in light and dark modes with Orange Compact theme](https://ios.unified-design-system.orange.com/images/OUDSComponents/component_static_list_item_OrangeCompact.png)
    }
    @Tab("Navigation") {
        ![A navigation list item component in light and dark modes with Orange Compact theme](https://ios.unified-design-system.orange.com/images/OUDSComponents/component_navigation_list_item_OrangeCompact.png)
    }
}
