...
///
/// - Since: 0.17.0
final class OrangeCompactThemePinCodeInputComponentTokensProvider: AllPinCodeInputComponentTokensProvider {
    ...
    {
        OL.debug("Init of OrangeCompactThemePinCodeInputComponentTokensProvider")
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeCompactThemePinCodeInputComponentTokensProvider")
        #endif
    }
    ...
    // the implementation of PinCodeInputComponentTokens is not here but in Core/Themes/OrangeCompact/Values/ComponentTokens/OrangeCompactTheme+PinCodeInputComponentTokens.swift
    // This declaration of OrangeCompactThemePinCodeInputComponentTokensProvider is here also to allow to write documentation.
}
