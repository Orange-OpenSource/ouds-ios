...
///
/// - Since: 1.2.0
final class OrangeCompactThemeAlertComponentTokensProvider: AllAlertComponentTokensProvider {
    ...
    {
        OL.debug("Init of OrangeCompactThemeAlertComponentTokensProvider")
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeCompactThemeAlertComponentTokensProvider")
        #endif
    }
    ...
    // the implementation of AlertComponentTokens is not here but in Core/Themes/OrangeCompact/Values/ComponentTokens/OrangeCompactTheme+AlertComponentTokens.swift
    // This declaration of OrangeCompactThemeAlertComponentTokensProvider is here also to allow to write documentation.
}
