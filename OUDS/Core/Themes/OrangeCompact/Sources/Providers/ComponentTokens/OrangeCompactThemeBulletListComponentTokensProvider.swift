...
///
/// - Since: 0.17.0
final class OrangeCompactThemeBulletListComponentTokensProvider: AllBulletListComponentTokensProvider {
    ...
    init(spaces: AllSpaceSemanticTokensProvider? = nil) {
        OL.debug("Init of OrangeCompactThemeBulletListComponentTokensProvider")
        self.spaces = (spaces ?? OrangeCompactThemeSpaceSemanticTokensProvider())
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeCompactThemeBulletListComponentTokensProvider")
        #endif
    }
    ...
    // the implementation of BulletListComponentTokens is not here but in Core/Themes/OrangeCompact/Values/ComponentTokens/OrangeCompactTheme+BulletListComponentTokens.swift
    // This declaration of OrangeCompactThemeBulletListComponentTokensProvider is here also to allow to write documentation.
}
