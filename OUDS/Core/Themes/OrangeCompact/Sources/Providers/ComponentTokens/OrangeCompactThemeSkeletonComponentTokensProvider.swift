...
///
/// - Since: 0.17.0
final class OrangeCompactThemeSkeletonComponentTokensProvider: AllSkeletonComponentTokensProvider {
    ...
    init(colors: AllColorSemanticTokensProvider? = nil) {
        OL.debug("Init of OrangeCompactThemeSkeletonComponentTokensProvider")
        self.colors = (colors ?? OrangeCompactThemeColorSemanticTokensProvider())
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeCompactThemeSkeletonComponentTokensProvider")
        #endif
    }
    ...
    // Core/Themes/OrangeCompact/Values/ComponentTokens/OrangeCompactTheme+SkeletonComponentTokens.swift
    // This declaration of OrangeCompactThemeSkeletonComponentTokensProvider is here also to allow to write documentation.
}
