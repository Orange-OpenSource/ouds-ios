...
///
/// - Since: 0.20.0
final class OrangeCompactThemeIconComponentTokensProvider: AllIconComponentTokensProvider {
    ...
    init(colors: AllColorSemanticTokensProvider? = nil) {
        OL.debug("Init of OrangeCompactThemeIconComponentTokensProvider")
        self.colors = (colors ?? OrangeCompactThemeColorSemanticTokensProvider())
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeCompactThemeIconComponentTokensProvider")
        #endif
    }
    ...
    // the implementation of IconComponentTokens is not here but in Core/Themes/OrangeCompact/Values/ComponentTokens/OrangeCompactTheme+IconComponentTokens.swift
    // This declaration of OrangeCompactThemeIconComponentTokensProvider is here also to allow to write documentation.
}
