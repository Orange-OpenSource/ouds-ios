...
///
/// - Since: 3.0.0
final class OrangeCompactThemeAlertMessageComponentTokensProvider: AllAlertMessageComponentTokensProvider {
    ...
    {
        OL.debug("Init of OrangeCompactThemeAlertMessageComponentTokensProvider")
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeCompactThemeAlertMessageComponentTokensProvider")
        #endif
    }
