...
///
/// - Since: 0.17.0
final class OrangeCompactThemeRadioButtonComponentTokensProvider: AllRadioButtonComponentTokensProvider {
    ...
    {
        OL.debug("Init of OrangeCompactThemeRadioButtonComponentTokensProvider")
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeCompactThemeRadioButtonComponentTokensProvider")
        #endif
    }
    ...
    // the implementation of RadioButtonComponentTokens is not here but in Core/Themes/OrangeCompact/Values/ComponentTokens/OrangeCompactTheme+RadioButtonComponentTokens.swift
    // This declaration of OrangeCompactThemeRadioButtonComponentTokensProvider is here also to allow to write documentation.
}
