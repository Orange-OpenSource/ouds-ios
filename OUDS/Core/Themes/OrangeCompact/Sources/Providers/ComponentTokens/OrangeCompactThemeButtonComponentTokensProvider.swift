...
///
/// - Since: 0.17.0
final class OrangeCompactThemeButtonComponentTokensProvider: AllButtonComponentTokensProvider {
    ...
    {
        OL.debug("Init of OrangeCompactThemeButtonComponentTokensProvider")
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeCompactThemeButtonComponentTokensProvider")
        #endif
    }
    ...
    // the implementation of ButtonComponentTokens is not here but in Core/Themes/OrangeCompact/Values/ComponentTokens/OrangeCompactTheme+ButtonComponentTokens.swift
    // This declaration of OrangeCompactThemeButtonComponentTokensProvider is here also to allow to write documentation.
}
