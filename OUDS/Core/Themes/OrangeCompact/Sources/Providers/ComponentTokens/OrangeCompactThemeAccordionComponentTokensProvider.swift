...
///
/// - Since: 3.0.0
final class OrangeCompactThemeAccordionComponentTokensProvider: AllAccordionComponentTokensProvider {
    ...
    {
        OL.debug("Init of OrangeCompactThemeAccordionComponentTokensProvider")
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeCompactThemeAccordionComponentTokensProvider")
        #endif
    }
    ...
    // the implementation of AccordionComponentTokens is not here but in Core/Themes/OrangeCompact/Values/ComponentTokens/OrangeCompactTheme+AccordionComponentTokens.swift
    // This declaration of OrangeCompactThemeAccordionComponentTokensProvider is here also to allow to write documentation.
}
