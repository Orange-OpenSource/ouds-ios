...
///
/// - Since: 0.17.0
final class OrangeCompactThemeCheckboxComponentTokensProvider: AllCheckboxComponentTokensProvider {
    ...
    {
        OL.debug("Init of OrangeCompactThemeCheckboxComponentTokensProvider")
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeCompactThemeCheckboxComponentTokensProvider")
        #endif
    }
    ...
    // Core/Themes/OrangeCompact/Values/ComponentTokens/OrangeCompactTheme+CheckboxComponentTokens.swift
    // This declaration of OrangeCompactThemeCheckboxComponentTokensProvider is here also to allow to write documentation.
}
