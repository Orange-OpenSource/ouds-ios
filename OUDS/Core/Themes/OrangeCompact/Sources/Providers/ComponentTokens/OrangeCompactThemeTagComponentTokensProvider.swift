...
///
/// - Since: 0.17.0
final class OrangeCompactThemeTagComponentTokensProvider: AllTagComponentTokensProvider {
    ...
    ///    - borders: Provider for borders semantic tokens. If nil, a default one will be used (``OrangeCompactThemeBorderSemanticTokensProvider``)
    ///    - spaces: Provider for spaces semantic tokens. If nil, a default one will be used (``OrangeCompactThemeSpaceSemanticTokensProvider``)
    ...
    {
        OL.debug("Init of OrangeCompactThemeTagComponentTokensProvider")
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeCompactThemeTagComponentTokensProvider")
        #endif
    }
    ...
    // the implementation of TagComponentTokens is not here but in Core/Themes/OrangeCompact/Values/ComponentTokens/OrangeCompactTheme+TagComponentTokens.swift
    // This declaration of OrangeCompactwThemeTagComponentTokensProvider is here also to allow to write documentation.
}
