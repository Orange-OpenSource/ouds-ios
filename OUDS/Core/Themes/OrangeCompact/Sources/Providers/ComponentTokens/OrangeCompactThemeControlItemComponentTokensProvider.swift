...
///
/// - Since: 0.14.0
final class OrangeCompactThemeControlItemComponentTokensProvider: AllControlItemComponentTokensProvider {
    ...
    // the implementation of ControlItemComponentTokens is not here but in Core/Themes/OrangeCompact/Values/ComponentTokens/OrangeCompactTheme+ControlItemComponentTokens.swift
    // This declaration of OrangeCompactThemeControlItemComponentTokensProvider is here also to allow to write documentation.
}
