...
///
/// - Since: 0.17.0
final class OrangeCompactThemeInputTagComponentTokensProvider: AllInputTagComponentTokensProvider {
    ...
    ///    - colors: Provider for _ semantic tokens. If nil, a default one will be used (``OrangeCompactThemeColorSemanticTokensProvider``)
    init(borders: AllBorderSemanticTokensProvider? = nil,
         colors: AllColorSemanticTokensProvider? = nil)
    {
        OL.debug("Init of OrangeCompactThemeInputTagComponentTokensProvider")
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeCompactThemeInputTagComponentTokensProvider")
        #endif
    }
    ...
    // Core/Themes/OrangeCompact/Values/ComponentTokens/OrangeCompactTheme+InputTagComponentTokens.swift
    // This declaration of OrangeCompactThemeInputTagComponentTokensProvider is here also to allow to write documentation.
}
