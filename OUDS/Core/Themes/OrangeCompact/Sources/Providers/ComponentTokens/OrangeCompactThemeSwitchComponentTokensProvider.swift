...
///
/// - Since: 0.17.0
final class OrangeCompactThemeSwitchComponentTokensProvider: AllSwitchComponentTokensProvider {
    ...
    {
        OL.debug("Init of OrangeCompactThemeSwitchComponentTokensProvider")
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeCompactThemeSwitchComponentTokensProvider")
        #endif
    }
    ...
    // the implementation of SwitchComponentTokens is not here but in Core/Themes/OrangeCompact/Values/ComponentTokens/OrangeCompactTheme+SwitchComponentTokens.swift
    // This declaration of OrangeCompactThemeSwitchComponentTokensProvider is here also to allow to write documentation.
}
