...
/// *Badge* components tokens are defined with semantic tokens ofimensions (`AllDimensionSemanticTokensProvider`)
/// and spaces (from `AllSpaceSemanticTokensProvider`).
///
/// - Since: 0.17.0
final class OrangeCompactThemeBadgeComponentTokensProvider: AllBadgeComponentTokensProvider {
    ...
    {
        OL.debug("Init of OrangeCompactThemeBadgeComponentTokensProvider")
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeCompactThemeBadgeComponentTokensProvider")
        #endif
    }
    ...
    // the implementation of BadgeComponentTokens is not here but in Core/Themes/OrangeCompact/Values/ComponentTokens/OrangeCompactTheme+BadgeComponentTokens.swift
    // This declaration of OrangeCompactThemeBadgeComponentTokensProvider is here also to allow to write documentation.
}
