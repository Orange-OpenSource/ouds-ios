...
///
/// - Since: 3.0.0
final class OrangeCompactThemeTypographyComponentTokensProvider: AllTypographyComponentTokensProvider {
    ...
    // the implementation of TypographyComponentTokens is not here but in Core/Themes/OrangeCompact/Values/ComponentTokens/OrangeCompactTheme+TypographyComponentTokens.swift
    // This declaration of OrangeCompactThemeTypographyComponentTokensProvider is here also to allow to write documentation.
}
