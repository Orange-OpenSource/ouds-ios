...
final class OrangeCompactThemeLinkComponentTokensProvider: AllLinkComponentTokensProvider {
    ...
    // the implementation of LinkComponentTokens is not here but in Core/Themes/OrangeCompact/Values/ComponentTokens/OrangeCompactTheme+LinkComponentTokens.swift
    // This declaration of OrangeCompactThemeLinkComponentTokensProvider is here also to allow to write documentation.
}
