...
///
/// - Since: 0.17.0
final class OrangeCompactThemeDimensionSemanticTokensProvider: AllDimensionSemanticTokensProvider {
    ...
    init() {
        OL.debug("Init of OrangeCompactThemeDimensionSemanticTokensProvider")
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeCompactThemeDimensionSemanticTokensProvider")
        #endif
    }
    ...
    // but in Core/Themes/OrangeCompact/Values/SemanticTokens/OrangeCompactTheme+DimensionSemanticTokens.swift
    // This declaration of OrangeCompactThemeDimensionSemanticTokensProvider is here to allow to write documentation.
}
