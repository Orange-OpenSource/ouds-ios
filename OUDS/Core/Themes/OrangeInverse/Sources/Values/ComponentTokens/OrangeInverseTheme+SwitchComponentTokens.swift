...
extension OrangeInverseThemeSwitchComponentTokensProvider: SwitchComponentTokens {
    ...
    /// Has for value token MultipleColorSemanticTokens(colors.colorRepositoryPositiveDefault)
    @objc public final var switchColorTrackSelected: MultipleColorSemanticTokens { MultipleColorSemanticTokens(colors.colorRepositoryPositiveDefault) }
