...
extension OrangeInverseThemeTextInputComponentTokensProvider: TextInputComponentTokens {
    /// Has for value token colors.colorBorderDefault
    @objc public final var ouds1f4a0TextInputColorBorderEnabled: MultipleColorSemanticTokens { colors.colorBorderDefault }
    /// Has for value token colors.colorActionHover
    @objc public final var ouds1f4a0TextInputColorBorderHover: MultipleColorSemanticTokens { colors.colorActionHover }
    /// Has for value token colors.colorBorderEmphasized
    @objc public final var ouds1f4a0TextInputColorBorderFocus: MultipleColorSemanticTokens { colors.colorBorderEmphasized }
    /// Has for value token colors.colorBorderEmphasized
    @objc public final var ouds1f4a0TextInputColorBorderLoading: MultipleColorSemanticTokens { colors.colorBorderEmphasized }
