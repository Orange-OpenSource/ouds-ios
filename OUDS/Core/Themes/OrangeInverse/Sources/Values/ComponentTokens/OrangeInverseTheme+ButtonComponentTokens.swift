...
extension OrangeInverseThemeButtonComponentTokensProvider: ButtonComponentTokens {
    /// Has for value token colors.colorSurfaceBrandPrimary
    @objc public final var buttonColorBgBrandEnabled: MultipleColorSemanticTokens { colors.colorSurfaceBrandPrimary }
    ...
    /// Has for value token MultipleColorSemanticTokens(colors.colorRepositoryNeutralMutedLower)
    @objc public final var buttonColorBgBrandPressed: MultipleColorSemanticTokens { MultipleColorSemanticTokens(colors.colorRepositoryNeutralMutedLower) }
    /// Has for value token MultipleColorSemanticTokens(colors.colorRepositoryNeutralMutedLower)
    @objc public final var buttonColorBgBrandLoading: MultipleColorSemanticTokens { MultipleColorSemanticTokens(colors.colorRepositoryNeutralMutedLower) }
    ...
    @objc public final var buttonColorContentBrandEnabled: MultipleColorSemanticTokens { colors.colorContentOnBrandPrimary }
    ...
    /// Has for value token MultipleColorSemanticTokens(colors.colorRepositoryNeutralEmphasizedBlack)
    @objc public final var buttonColorContentBrandPressed: MultipleColorSemanticTokens { MultipleColorSemanticTokens(colors.colorRepositoryNeutralEmphasizedBlack) }
    /// Has for value token MultipleColorSemanticTokens(colors.colorRepositoryNeutralEmphasizedBlack)
    @objc public final var buttonColorContentBrandLoading: MultipleColorSemanticTokens { MultipleColorSemanticTokens(colors.colorRepositoryNeutralEmphasizedBlack) }
    ...
    @objc public final var buttonBorderRadiusRounded: BorderRadiusSemanticToken { borders.borderRadiusMedium }
