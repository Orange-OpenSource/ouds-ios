...
/// These values can be overriden inside ``OrangeInverseThemeFontSemanticTokensProvider`` subclasses (in extensions or not, in the same module or not) thanks to the `@objc open` combination.
...
extension OrangeInverseThemeFontSemanticTokensProvider: FontCompositeSemanticTokens {
