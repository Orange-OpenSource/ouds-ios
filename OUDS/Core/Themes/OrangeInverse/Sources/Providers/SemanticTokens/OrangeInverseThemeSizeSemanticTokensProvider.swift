...
///
/// - Since: 0.17.0
final class OrangeInverseThemeSizeSemanticTokensProvider: AllSizeSemanticTokensProvider {
    ...
    init(dimensions: AllDimensionSemanticTokensProvider? = nil) {
        OL.debug("Init of OrangeInverseThemeSizeSemanticTokensProvider")
    ...
    // but in Core/Themes/OrangeInverse/Values/SemanticTokens/OrangeInverseTheme+SizeSemanticTokens.swift
    // and in Core/Themes/OrangeInverse/Values/SemanticTokens/OrangeInverseTheme+SizeMultipleSemanticTokens.swift
    // This declaration of OrangeInverseThemeSizeSemanticTokensProvider is here to allow to write documentation.
}
