...
///
/// - Since: 0.17.0
final class OrangeInverseThemeColorModeSemanticTokensProvider: AllColorModeSemanticTokensProvider {
    ...
    public init(colors: AllColorSemanticTokensProvider? = nil) {
        OL.debug("Init of OrangeInverseThemeColorModeSemanticTokensProvider")
        self.colors = (colors ?? OrangeInverseThemeColorSemanticTokensProvider())
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeInverseThemeColorModeSemanticTokensProvider")
        #endif
    }
    ...
    // but in Core/Themes/OrangeInverse/Values/SemanticTokens/OrangeInverseTheme+ColorModeMultipleSemanticTokens.swift
