...
///
/// - Since: 0.17.0
final class OrangeInverseThemeDimensionSemanticTokensProvider: AllDimensionSemanticTokensProvider {
    ...
    init() {
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeInverseThemeDimensionSemanticTokensProvider")
        #endif
    }
