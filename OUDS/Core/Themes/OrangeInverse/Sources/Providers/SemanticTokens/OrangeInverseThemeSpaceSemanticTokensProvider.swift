...
///
/// - Since: 0.17.0
final class OrangeInverseThemeSpaceSemanticTokensProvider: AllSpaceSemanticTokensProvider {
    ...
    public init(dimensions: AllDimensionSemanticTokensProvider? = nil) {
        OL.debug("Init of OrangeInverseThemeSpaceSemanticTokensProvider")
        self.dimensions = (dimensions ?? OrangeInverseThemeDimensionSemanticTokensProvider())
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeInverseThemeSizeSemanticTokensProvider")
        #endif
    }
    ...
    // but in Core/Themes/OrangeInverse/Values/SemanticTokens/OrangeInverseTheme+SpaceSemanticTokens.swift
    // and in Core/Themes/OrangeInverse/Values/SemanticTokens/OrangeInverseTheme+SpaceMultipleSemanticTokens.swift
    // This declaration of OrangeInverseThemeSpaceSemanticTokensProvider is here to allow to write documentation.
}
