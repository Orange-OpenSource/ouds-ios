...
final class OrangeInverseThemeControlItemComponentTokensProvider: AllControlItemComponentTokensProvider {
         ...
         spaces: AllSpaceSemanticTokensProvider? = nil)
    {
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeInverseThemeControlItemComponentTokensProvider")
        #endif
    }
    ...
    // the implemention of ControlItemComponentTokens is not here but in Core/Themes/OrangeInverse/Values/ComponentTokens/OrangeInverseTheme+ControlItemComponentTokens.swift
    // This declaration of OrangeInverseThemeControlItemComponentTokensProvider is here also to allow to write documentation.
}
