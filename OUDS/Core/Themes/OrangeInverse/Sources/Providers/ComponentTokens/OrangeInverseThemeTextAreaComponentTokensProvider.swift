...
///
/// - Since: 0.17.0
final class OrangeInverseThemeTextAreaComponentTokensProvider: AllTextAreaComponentTokensProvider {
    ...
    {
        OL.debug("Init of OrangeInverseThemeTextAreaComponentTokensProvider")
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeInverseThemeTextAreaComponentTokensProvider")
        #endif
    }
    ...
    // the implemention of TextAreaComponentTokens is not here but in Core/Themes/OrangeInverse/Values/ComponentTokens/OrangeInverseTheme+TextAreaComponentTokens.swift
    // This declaration of OrangeInverseThemeTextAreaComponentTokensProvider is here also to allow to write documentation.
}
