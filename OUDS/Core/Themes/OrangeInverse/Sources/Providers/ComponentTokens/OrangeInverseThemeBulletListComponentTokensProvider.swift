...
///
/// - Since: 0.17.0
final class OrangeInverseThemeBulletListComponentTokensProvider: AllBulletListComponentTokensProvider {
    ...
    /// - Parameter spaces: Provider for space semantic tokens. If nil, a default one will be used (``OrangeInverseThemeSpaceSemanticTokensProvider``)
    init(spaces: AllSpaceSemanticTokensProvider? = nil) {
        OL.debug("Init of OrangeInverseThemeBulletListComponentTokensProvider")
        self.spaces = (spaces ?? OrangeInverseThemeSpaceSemanticTokensProvider())
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeInverseThemeBulletListComponentTokensProvider")
        #endif
    }
    ...
    // the implemention of BulletListComponentTokens is not here but in Core/Themes/OrangeInverse/Values/ComponentTokens/OrangeInverseTheme+BulletListComponentTokens.swift
    // This declaration of OrangeInverseThemeBulletListComponentTokensProvider is here also to allow to write documentation.
}
