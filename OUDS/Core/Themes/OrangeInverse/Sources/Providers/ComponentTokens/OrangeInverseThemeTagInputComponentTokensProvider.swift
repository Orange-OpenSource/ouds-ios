...
///
/// - Since: 0.17.0
final class OrangeInverseThemeTagInputComponentTokensProvider: AllTagInputComponentTokensProvider {
    ...
    {
        OL.debug("Init of OrangeInverseThemeTagInputComponentTokensProvider")
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeInverseThemeTagInputComponentTokensProvider")
        #endif
    }
    ...
    // the implemention of TagInputComponentTokens is not here but in Core/Themes/OrangeInverse/Values/ComponentTokens/OrangeInverseTheme+TagInputComponentTokens.swift
    // This declaration of OrangeInverseThemeTagInputComponentTokensProvider is here also to allow to write documentation.
}
