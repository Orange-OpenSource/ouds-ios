...
///
/// - Since: 0.17.0
final class OrangeInverseThemeRadioButtonComponentTokensProvider: AllRadioButtonComponentTokensProvider {
    ...
    {
        OL.debug("Init of OrangeInverseThemeRadioButtonComponentTokensProvider")
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeInverseThemeRadioButtonComponentTokensProvider")
        #endif
    }
    ...
    // the implemention of RadioButtonComponentTokens is not here but in Core/Themes/OrangeInverse/Values/ComponentTokens/OrangeInverseTheme+RadioButtonComponentTokens.swift
    // This declaration of OrangeInverseThemeRadioButtonComponentTokensProvider is here also to allow to write documentation.
}
