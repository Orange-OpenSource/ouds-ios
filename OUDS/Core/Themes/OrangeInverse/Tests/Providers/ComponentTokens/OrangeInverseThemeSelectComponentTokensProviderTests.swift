...
struct OrangeInverseThemeSelectComponentTokensProviderTests {

    private var provider: OrangeInverseThemeSelectComponentTokensProvider

    init() {
        provider = OrangeInverseThemeSelectComponentTokensProvider()
    }
