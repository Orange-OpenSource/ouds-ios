...
struct OrangeInverseThemeControlItemComponentTokensProviderTests {

    private var provider: OrangeInverseThemeControlItemComponentTokensProvider

    init() {
        provider = OrangeInverseThemeControlItemComponentTokensProvider()
    }
