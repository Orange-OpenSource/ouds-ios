...
final class OrangeInverseThemePinCodeInputComponentTokensProvider: AllPinCodeInputComponentTokensProvider {
    ...
    {
        OL.debug("Init of OrangeInversesThemePinCodeInputComponentTokensProvider")
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "OrangeInversesThemePinCodeInputComponentTokensProvider")
        #endif
    }
