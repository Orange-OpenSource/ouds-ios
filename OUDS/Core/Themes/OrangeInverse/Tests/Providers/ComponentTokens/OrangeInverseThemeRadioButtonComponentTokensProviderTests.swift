...
struct OrangeInverseThemeRadioButtonComponentTokensProviderTests {

    private var provider: OrangeInverseThemeRadioButtonComponentTokensProvider

    init() {
        provider = OrangeInverseThemeRadioButtonComponentTokensProvider()
    }
