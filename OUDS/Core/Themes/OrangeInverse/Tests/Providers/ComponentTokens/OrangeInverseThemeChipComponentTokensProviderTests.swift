...
struct OrangeInverseThemeChipComponentTokensProviderTests {

    private var provider: OrangeInverseThemeChipComponentTokensProvider

    init() {
        provider = OrangeInverseThemeChipComponentTokensProvider()
    }
