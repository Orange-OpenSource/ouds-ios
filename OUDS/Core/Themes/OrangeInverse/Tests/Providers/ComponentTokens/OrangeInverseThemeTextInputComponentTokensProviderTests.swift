...
struct OrangeInverseThemeTextInputComponentTokensProviderTests {

    private var provider: OrangeInverseThemeTextInputComponentTokensProvider

    init() {
        provider = OrangeInverseThemeTextInputComponentTokensProvider()
    }
