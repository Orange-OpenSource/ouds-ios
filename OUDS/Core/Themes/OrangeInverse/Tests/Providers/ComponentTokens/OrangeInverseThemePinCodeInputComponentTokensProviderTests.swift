...
struct OrangeInverseThemePinCodeInputComponentTokensProviderTests {

    private var provider: OrangeInverseThemePinCodeInputComponentTokensProvider

    init() {
        provider = OrangeInverseThemePinCodeInputComponentTokensProvider()
    }
