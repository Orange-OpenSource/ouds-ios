...
struct OrangeInverseThemeSkeletonComponentTokensProviderTests {

    private var provider: OrangeInverseThemeSkeletonComponentTokensProvider

    init() {
        provider = OrangeInverseThemeSkeletonComponentTokensProvider()
    }
