...
struct OrangeInverseThemeListItemComponentTokensProviderTests {

    private var provider: OrangeInverseThemeListItemComponentTokensProvider

    init() {
        provider = OrangeInverseThemeListItemComponentTokensProvider()
    }
