...
struct OrangeInverseThemeButtonComponentTokensProviderTests {

    private var provider: OrangeInverseThemeButtonComponentTokensProvider

    init() {
        provider = OrangeInverseThemeButtonComponentTokensProvider()
    }
