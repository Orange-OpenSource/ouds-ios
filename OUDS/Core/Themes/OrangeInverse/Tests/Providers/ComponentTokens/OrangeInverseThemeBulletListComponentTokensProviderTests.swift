...
struct OrangeInverseThemeBulletListComponentTokensProviderTests {

    private var provider: OrangeInverseThemeBulletListComponentTokensProvider

    init() {
        provider = OrangeInverseThemeBulletListComponentTokensProvider()
    }
