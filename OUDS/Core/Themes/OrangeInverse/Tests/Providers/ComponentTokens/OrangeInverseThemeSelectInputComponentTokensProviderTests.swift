...
struct OrangeInverseThemeSelectInputComponentTokensProviderTests {

    private var provider: OrangeInverseThemeSelectInputComponentTokensProvider

    init() {
        provider = OrangeInverseThemeSelectInputComponentTokensProvider()
    }
