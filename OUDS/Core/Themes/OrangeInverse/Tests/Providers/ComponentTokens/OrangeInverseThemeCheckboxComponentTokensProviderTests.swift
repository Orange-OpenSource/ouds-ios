...
struct OrangeInverseThemeCheckboxComponentTokensProviderTests {

    private var provider: OrangeInverseThemeCheckboxComponentTokensProvider

    init() {
        provider = OrangeInverseThemeCheckboxComponentTokensProvider()
    }
