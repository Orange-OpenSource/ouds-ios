...
struct OrangeInverseThemeTagInputComponentTokensProviderTests {

    private var provider: OrangeInverseThemeTagInputComponentTokensProvider

    init() {
        provider = OrangeInverseThemeTagInputComponentTokensProvider()
    }
