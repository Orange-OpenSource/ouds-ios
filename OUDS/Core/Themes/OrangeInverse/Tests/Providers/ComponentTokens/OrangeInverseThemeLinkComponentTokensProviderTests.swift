...
struct OrangeInverseThemeLinkComponentTokensProviderTests {

    private var provider: OrangeInverseThemeLinkComponentTokensProvider

    init() {
        provider = OrangeInverseThemeLinkComponentTokensProvider()
    }
