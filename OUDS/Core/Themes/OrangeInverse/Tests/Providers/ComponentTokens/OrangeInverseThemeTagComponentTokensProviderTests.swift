...
struct OrangeInverseThemeTagComponentTokensProviderTests {

    private var provider: OrangeInverseThemeTagComponentTokensProvider

    init() {
        provider = OrangeInverseThemeTagComponentTokensProvider()
    }
