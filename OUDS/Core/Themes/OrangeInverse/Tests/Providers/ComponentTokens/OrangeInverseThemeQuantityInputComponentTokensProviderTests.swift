...
struct OrangeInverseThemeQuantiyInputComponentTokensProviderTests {

    private var provider: OrangeInverseThemeQuantityInputComponentTokensProvider

    init() {
        provider = OrangeInverseThemeQuantityInputComponentTokensProvider()
    }
