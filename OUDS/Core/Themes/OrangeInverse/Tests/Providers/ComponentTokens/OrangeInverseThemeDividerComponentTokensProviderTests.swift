...
struct OrangeInverseThemeDividerComponentTokensProviderTests {

    private var provider: OrangeInverseThemeDividerComponentTokensProvider

    init() {
        provider = OrangeInverseThemeDividerComponentTokensProvider()
    }
