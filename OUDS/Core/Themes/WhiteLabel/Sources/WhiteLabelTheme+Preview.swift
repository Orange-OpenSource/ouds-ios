...
extension View {
    ...
    /// Wraps `self` `View` inside an `OUDSThemeableView` applying the ``WhiteLabelTheme``.
    ...
    ///         var body: some View {
    ///            yourContentView.whiteLabelPreview()
    ///         }
    ///     }
    ///
    ///     // In their side:
    ...
    @ViewBuilder
    public func whiteLabelPreview() -> some View {
        #if DEBUG
