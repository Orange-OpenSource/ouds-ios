...
extension OUDSTheme: ColorSemanticTokens {
    ...
    @objc open var colorRepositoryAccentHighestLight: ColorSemanticToken { ColorRawTokens.colorWarmGray900 }
    @objc open var colorRepositoryAccentLowLight: ColorSemanticToken { ColorRawTokens.colorFunctionalSun300 }
    @objc open var colorRepositoryAccentLowestLight: ColorSemanticToken { ColorRawTokens.colorWarmGray100 }
    @objc open var colorRepositoryAccentDefaultDark: ColorSemanticToken { ColorRawTokens.colorFunctionalSun500 }
    @objc open var colorRepositoryAccentHighestDark: ColorSemanticToken { ColorRawTokens.colorWarmGray900 }
    @objc open var colorRepositoryAccentLowDark: ColorSemanticToken { ColorRawTokens.colorFunctionalSun300 }
    @objc open var colorRepositoryAccentLowestDark: ColorSemanticToken { ColorRawTokens.colorWarmGray100 }
    ...
    @objc open var colorRepositoryPrimaryDefaultLight: ColorSemanticToken { ColorRawTokens.colorOrange550 }
    @objc open var colorRepositoryPrimaryLowLight: ColorSemanticToken { ColorRawTokens.colorOrange500 }
    @objc open var colorRepositoryPrimaryDefaultDark: ColorSemanticToken { ColorRawTokens.colorOrange550 }
    @objc open var colorRepositoryPrimaryLowDark: ColorSemanticToken { ColorRawTokens.colorOrange500 }
