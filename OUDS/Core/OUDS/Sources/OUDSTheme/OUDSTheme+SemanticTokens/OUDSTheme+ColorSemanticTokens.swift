...
extension OUDSTheme: ColorSemanticTokens {
    ...
    @objc open var colorActionPrimaryLoadingLight: ColorSemanticToken { ColorRawTokens.colorOrange550 }
    @objc open var colorActionPrimaryLoadingOnBgEmphasizedLight: ColorSemanticToken { ColorRawTokens.colorOrange500 }
    @objc open var colorActionPrimaryPressedLight: ColorSemanticToken { ColorRawTokens.colorOrange550 }
    @objc open var colorActionPrimaryPressedOnBgEmphasizedLight: ColorSemanticToken { ColorRawTokens.colorOrange500 }
    ...
    @objc open var colorActionPrimaryLoadingDark: ColorSemanticToken { ColorRawTokens.colorOrange500 }
    @objc open var colorActionPrimaryLoadingOnBgEmphasizedDark: ColorSemanticToken { ColorRawTokens.colorOrange500 }
    @objc open var colorActionPrimaryPressedDark: ColorSemanticToken { ColorRawTokens.colorOrange500 }
    @objc open var colorActionPrimaryPressedOnBgEmphasizedDark: ColorSemanticToken { ColorRawTokens.colorOrange500 }
    ...
    @objc open var colorActionSelectedOnBgEmphasizedLight: ColorSemanticToken { ColorRawTokens.colorOrange500 }
    ...
    @objc open var colorActionSelectedOnBgEmphasizedDark: ColorSemanticToken { ColorRawTokens.colorOrange500 }
    ...
    @objc open var colorBgBrandPrimaryLight: ColorSemanticToken { ColorRawTokens.colorOrange550 }
    ...
    @objc open var colorBgStatusAccentMutedLight: ColorSemanticToken { ColorRawTokens.colorWarmGray100 }
    @objc open var colorBgStatusAccentMutedOnBgEmphasizedLight: ColorSemanticToken { ColorRawTokens.colorWarmGray900 }
    ...
    @objc open var colorBgStatusAccentMutedDark: ColorSemanticToken { ColorRawTokens.colorWarmGray900 }
    @objc open var colorBgStatusAccentMutedOnBgEmphasizedDark: ColorSemanticToken { ColorRawTokens.colorWarmGray900 }
    ...
    @objc open var colorBgBrandPrimaryDark: ColorSemanticToken { ColorRawTokens.colorOrange500 }
    ...
    @objc open var colorBorderBrandPrimaryOnBgEmphasizedLight: ColorSemanticToken { ColorRawTokens.colorOrange500 }
    ...
    @objc open var colorBorderBrandPrimaryOnBgEmphasizedDark: ColorSemanticToken { ColorRawTokens.colorOrange500 }
    ...
    @objc open var colorChartCategoricalBrandLight: ColorSemanticToken { ColorRawTokens.colorOrange550 }
    ...
    @objc open var colorChartCategoricalBrandDark: ColorSemanticToken { ColorRawTokens.colorOrange500 }
    ...
    @objc open var colorContentBrandPrimaryOnBgEmphasizedLight: ColorSemanticToken { ColorRawTokens.colorOrange500 }
    ...
    @objc open var colorContentBrandPrimaryOnBgEmphasizedDark: ColorSemanticToken { ColorRawTokens.colorOrange500 }
